...
export default class SqlParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"sql_script", "batch", "sql_clauses", "sql_clause", "dml_clause", "ddl_clause", 
		"drop_sequence", "alter_sequence", "create_sequence", "delete_statement", 
	...
	public sql_script(): Sql_scriptContext {
		...
		this.enterRule(localctx, 0, SqlParser.RULE_sql_script);
		let _la: number;
		try {
	...
	public batch(): BatchContext {
		...
		this.enterRule(localctx, 2, SqlParser.RULE_batch);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 326;
	...
	public sql_clauses(): Sql_clausesContext {
		...
		this.enterRule(localctx, 4, SqlParser.RULE_sql_clauses);
		let _la: number;
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
	...
	public sql_clause(): Sql_clauseContext {
		...
		this.enterRule(localctx, 6, SqlParser.RULE_sql_clause);
		try {
			this.state = 338;
			this._errHandler.sync(this);
	...
	public dml_clause(): Dml_clauseContext {
		...
		this.enterRule(localctx, 8, SqlParser.RULE_dml_clause);
		try {
			this.state = 344;
			this._errHandler.sync(this);
	...
	public ddl_clause(): Ddl_clauseContext {
		...
		this.enterRule(localctx, 10, SqlParser.RULE_ddl_clause);
		try {
			this.state = 356;
			this._errHandler.sync(this);
	...
	public drop_sequence(): Drop_sequenceContext {
		...
		this.enterRule(localctx, 12, SqlParser.RULE_drop_sequence);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public alter_sequence(): Alter_sequenceContext {
		...
		this.enterRule(localctx, 14, SqlParser.RULE_alter_sequence);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
			...
			if (_la===156) {
				{
				this.state = 395;
				this.match(SqlParser.INCREMENT);
				this.state = 396;
				this.match(SqlParser.BY);
				this.state = 397;
				localctx._sequnce_increment = this.match(SqlParser.DECIMAL);
				}
			}
	...
	public create_sequence(): Create_sequenceContext {
		...
		this.enterRule(localctx, 16, SqlParser.RULE_create_sequence);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public delete_statement(): Delete_statementContext {
		...
		this.enterRule(localctx, 18, SqlParser.RULE_delete_statement);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
			...
			if (_la===373) {
				...
				case 74:
					...
					case 2:
						{
						this.state = 514;
						localctx._cursor_var = this.match(SqlParser.LOCAL_ID);
						}
						break;
					}
					}
	...
	public delete_statement_from(): Delete_statement_fromContext {
		...
		this.enterRule(localctx, 20, SqlParser.RULE_delete_statement_from);
		try {
			this.state = 534;
			this._errHandler.sync(this);
			...
			case 4:
				...
				{
				this.state = 533;
				localctx._table_var = this.match(SqlParser.LOCAL_ID);
				}
				break;
			}
		}
	...
	public insert_statement(): Insert_statementContext {
		...
		this.enterRule(localctx, 22, SqlParser.RULE_insert_statement);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public insert_statement_value(): Insert_statement_valueContext {
		...
		this.enterRule(localctx, 24, SqlParser.RULE_insert_statement_value);
		try {
			this.state = 583;
			this._errHandler.sync(this);
	...
	public select_statement(): Select_statementContext {
		...
		this.enterRule(localctx, 26, SqlParser.RULE_select_statement);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public update_statement(): Update_statementContext {
		...
		this.enterRule(localctx, 28, SqlParser.RULE_update_statement);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public output_clause(): Output_clauseContext {
		...
		this.enterRule(localctx, 30, SqlParser.RULE_output_clause);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public output_dml_list_elem(): Output_dml_list_elemContext {
		...
		this.enterRule(localctx, 32, SqlParser.RULE_output_dml_list_elem);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public output_column_name(): Output_column_nameContext {
		...
		this.enterRule(localctx, 34, SqlParser.RULE_output_column_name);
		try {
			this.state = 701;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			...
			case 808:
				...
				case 1:
					{
					this.state = 690;
					this.match(SqlParser.DELETED);
					}
					break;
				case 2:
					{
					this.state = 691;
					this.match(SqlParser.INSERTED);
					}
					break;
				case 3:
					{
			...
			case 793:
				...
				{
				this.state = 700;
				this.match(SqlParser.DOLLAR_ACTION);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public create_index(): Create_indexContext {
		...
		this.enterRule(localctx, 36, SqlParser.RULE_create_index);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public create_table(): Create_tableContext {
		...
		this.enterRule(localctx, 38, SqlParser.RULE_create_table);
		let _la: number;
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
			...
			case 753:
				{
				this.state = 762;
				this.match(SqlParser.TEXTIMAGE_ON);
				this.state = 763;
				this.id();
				}
				break;
	...
	public table_options(): Table_optionsContext {
		...
		this.enterRule(localctx, 40, SqlParser.RULE_table_options);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public create_view(): Create_viewContext {
		...
		this.enterRule(localctx, 42, SqlParser.RULE_create_view);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public view_attribute(): View_attributeContext {
		...
		this.enterRule(localctx, 44, SqlParser.RULE_view_attribute);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public alter_table(): Alter_tableContext {
		...
		this.enterRule(localctx, 46, SqlParser.RULE_alter_table);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
			...
			case 1:
				...
				this.match(SqlParser.LR_BRACKET);
				this.state = 829;
				this.match(SqlParser.LOCK_ESCALATION);
				this.state = 830;
	...
	public host(): HostContext {
		...
		this.enterRule(localctx, 48, SqlParser.RULE_host);
		try {
			this.state = 885;
			this._errHandler.sync(this);
	...
	public drop_index(): Drop_indexContext {
		...
		this.enterRule(localctx, 50, SqlParser.RULE_drop_index);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public drop_relational_or_xml_or_spatial_index(): Drop_relational_or_xml_or_spatial_indexContext {
		...
		this.enterRule(localctx, 52, SqlParser.RULE_drop_relational_or_xml_or_spatial_index);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 914;
	...
	public drop_backward_compatible_index(): Drop_backward_compatible_indexContext {
		...
		this.enterRule(localctx, 54, SqlParser.RULE_drop_backward_compatible_index);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 921;
	...
	public drop_table(): Drop_tableContext {
		...
		this.enterRule(localctx, 56, SqlParser.RULE_drop_table);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public drop_view(): Drop_viewContext {
		...
		this.enterRule(localctx, 58, SqlParser.RULE_drop_view);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public rowset_function_limited(): Rowset_function_limitedContext {
		...
		this.enterRule(localctx, 60, SqlParser.RULE_rowset_function_limited);
		try {
			this.state = 956;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public openquery(): OpenqueryContext {
		...
		this.enterRule(localctx, 62, SqlParser.RULE_openquery);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 958;
			this.match(SqlParser.OPENQUERY);
			this.state = 959;
			this.match(SqlParser.LR_BRACKET);
			this.state = 960;
			...
			this.match(SqlParser.COMMA);
			this.state = 962;
			localctx._query = this.match(SqlParser.STRING);
			this.state = 963;
			this.match(SqlParser.RR_BRACKET);
			}
		}
	...
	public opendatasource(): OpendatasourceContext {
		...
		this.enterRule(localctx, 64, SqlParser.RULE_opendatasource);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 965;
			this.match(SqlParser.OPENDATASOURCE);
			this.state = 966;
			this.match(SqlParser.LR_BRACKET);
			this.state = 967;
			localctx._provider = this.match(SqlParser.STRING);
			this.state = 968;
			this.match(SqlParser.COMMA);
			this.state = 969;
			localctx._init = this.match(SqlParser.STRING);
			this.state = 970;
			this.match(SqlParser.RR_BRACKET);
			this.state = 971;
			this.match(SqlParser.DOT);
	...
	public execute_statement(): Execute_statementContext {
		...
		this.enterRule(localctx, 66, SqlParser.RULE_execute_statement);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 982;
	...
	public execute_body(): Execute_bodyContext {
		...
		this.enterRule(localctx, 68, SqlParser.RULE_execute_body);
		let _la: number;
		try {
			this.state = 1027;
			this._errHandler.sync(this);
			...
			case 1:
				...
				case 1:
					{
					this.state = 985;
					localctx._return_status = this.match(SqlParser.LOCAL_ID);
					this.state = 986;
					this.match(SqlParser.EQUAL);
					}
					break;
	...
	public execute_statement_arg(): Execute_statement_argContext {
		...
		this.enterRule(localctx, 70, SqlParser.RULE_execute_statement_arg);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
			...
			case 1:
				{
				this.state = 1029;
				localctx._parameter = this.match(SqlParser.LOCAL_ID);
				this.state = 1030;
				this.match(SqlParser.EQUAL);
				}
				break;
	...
	public execute_var_string(): Execute_var_stringContext {
		...
		this.enterRule(localctx, 72, SqlParser.RULE_execute_var_string);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public column_def_table_constraints(): Column_def_table_constraintsContext {
		...
		this.enterRule(localctx, 74, SqlParser.RULE_column_def_table_constraints);
		let _la: number;
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
	...
	public column_def_table_constraint(): Column_def_table_constraintContext {
		...
		this.enterRule(localctx, 76, SqlParser.RULE_column_def_table_constraint);
		try {
			this.state = 1059;
			this._errHandler.sync(this);
	...
	public column_definition(): Column_definitionContext {
		...
		this.enterRule(localctx, 78, SqlParser.RULE_column_definition);
		let _la: number;
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
			...
			case 2:
				...
				case 1:
					...
					this.match(SqlParser.LR_BRACKET);
					this.state = 1084;
					localctx._seed = this.match(SqlParser.DECIMAL);
					this.state = 1085;
					this.match(SqlParser.COMMA);
					this.state = 1086;
					localctx._increment = this.match(SqlParser.DECIMAL);
					this.state = 1087;
					this.match(SqlParser.RR_BRACKET);
					}
					break;
			...
			if (_la===290) {
				{
				this.state = 1097;
				this.match(SqlParser.ROWGUIDCOL);
				}
			}
	...
	public materialized_column_definition(): Materialized_column_definitionContext {
		...
		this.enterRule(localctx, 80, SqlParser.RULE_materialized_column_definition);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public column_constraint(): Column_constraintContext {
		...
		this.enterRule(localctx, 82, SqlParser.RULE_column_constraint);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public table_constraint(): Table_constraintContext {
		...
		this.enterRule(localctx, 84, SqlParser.RULE_table_constraint);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public on_delete(): On_deleteContext {
		...
		this.enterRule(localctx, 86, SqlParser.RULE_on_delete);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1227;
	...
	public on_update(): On_updateContext {
		...
		this.enterRule(localctx, 88, SqlParser.RULE_on_update);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1238;
	...
	public index_options(): Index_optionsContext {
		...
		this.enterRule(localctx, 90, SqlParser.RULE_index_options);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public index_option(): Index_optionContext {
		...
		this.enterRule(localctx, 92, SqlParser.RULE_index_option);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1261;
	...
	public constant_LOCAL_ID(): Constant_LOCAL_IDContext {
		...
		this.enterRule(localctx, 94, SqlParser.RULE_constant_LOCAL_ID);
		try {
			this.state = 1270;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public moca_at_variable(): Moca_at_variableContext {
		...
		this.enterRule(localctx, 98, SqlParser.RULE_moca_at_variable);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1308;
			...
			case 2:
				...
				case 1:
					...
					{
					this.state = 1315;
					this.match(SqlParser.SHARP);
					this.state = 1316;
					this.match(SqlParser.KEEP);
					}
					}
					break;
				case 2:
					...
					this.match(SqlParser.SHARP);
					this.state = 1318;
					this.match(SqlParser.MOCA_ONSTACK);
					}
					}
					break;
				case 3:
					...
					this.match(SqlParser.SHARP);
					this.state = 1320;
					this.match(SqlParser.MOCA_IGNORE);
					}
					}
					break;
				}
	...
	public moca_environment_variable(): Moca_environment_variableContext {
		...
		this.enterRule(localctx, 100, SqlParser.RULE_moca_environment_variable);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1325;
			this.match(SqlParser.MOCA_ENVIRONMENT_VARIABLE);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public moca_at_minus_variable(): Moca_at_minus_variableContext {
		...
		this.enterRule(localctx, 102, SqlParser.RULE_moca_at_minus_variable);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1327;
			this.match(SqlParser.MOCA_AT_MINUS_VARIABLE);
			this.state = 1330;
			this._errHandler.sync(this);
	...
	public moca_at_plus_variable(): Moca_at_plus_variableContext {
		...
		this.enterRule(localctx, 104, SqlParser.RULE_moca_at_plus_variable);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1344;
			this.match(SqlParser.MOCA_AT_PLUS_VARIABLE);
			this.state = 1347;
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (_la===831) {
	...
	public moca_at_star(): Moca_at_starContext {
		...
		this.enterRule(localctx, 106, SqlParser.RULE_moca_at_star);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1355;
			this.match(SqlParser.MOCA_AT_STAR);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public moca_integration_variable(): Moca_integration_variableContext {
		...
		this.enterRule(localctx, 108, SqlParser.RULE_moca_integration_variable);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1357;
	...
	public primitive_expression(): Primitive_expressionContext {
		...
		this.enterRule(localctx, 110, SqlParser.RULE_primitive_expression);
		try {
			this.state = 1364;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public case_expression(): Case_expressionContext {
		...
		this.enterRule(localctx, 112, SqlParser.RULE_case_expression);
		let _la: number;
		try {
			this.state = 1391;
			this._errHandler.sync(this);
	...
	public unary_operator_expression(): Unary_operator_expressionContext {
		...
		this.enterRule(localctx, 114, SqlParser.RULE_unary_operator_expression);
		let _la: number;
		try {
			this.state = 1397;
			this._errHandler.sync(this);
	...
	public bracket_expression(): Bracket_expressionContext {
		...
		this.enterRule(localctx, 116, SqlParser.RULE_bracket_expression);
		try {
			this.state = 1407;
			this._errHandler.sync(this);
	...
	public constant_expression(): Constant_expressionContext {
		...
		this.enterRule(localctx, 118, SqlParser.RULE_constant_expression);
		try {
			this.state = 1417;
			this._errHandler.sync(this);
	...
	public subquery(): SubqueryContext {
		...
		this.enterRule(localctx, 120, SqlParser.RULE_subquery);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1419;
	...
	public with_expression(): With_expressionContext {
		...
		this.enterRule(localctx, 122, SqlParser.RULE_with_expression);
		let _la: number;
		try {
			this.state = 1447;
			this._errHandler.sync(this);
			...
			case 1:
				...
				case 1:
					{
					this.state = 1422;
					this.match(SqlParser.XMLNAMESPACES);
					this.state = 1423;
					this.match(SqlParser.COMMA);
					}
					break;
			...
			case 2:
				...
				this.match(SqlParser.WITH);
				this.state = 1435;
				this.match(SqlParser.BLOCKING_HIERARCHY);
				this.state = 1440;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (_la===836) {
	...
	public common_table_expression(): Common_table_expressionContext {
		...
		this.enterRule(localctx, 124, SqlParser.RULE_common_table_expression);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public update_elem(): Update_elemContext {
		...
		this.enterRule(localctx, 126, SqlParser.RULE_update_elem);
		try {
			this.state = 1477;
			this._errHandler.sync(this);
	...
	public search_condition_list(): Search_condition_listContext {
		...
		this.enterRule(localctx, 128, SqlParser.RULE_search_condition_list);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public search_condition(): Search_conditionContext {
		...
		this.enterRule(localctx, 130, SqlParser.RULE_search_condition);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public search_condition_and(): Search_condition_andContext {
		...
		this.enterRule(localctx, 132, SqlParser.RULE_search_condition_and);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public search_condition_not(): Search_condition_notContext {
		...
		this.enterRule(localctx, 134, SqlParser.RULE_search_condition_not);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public predicate(): PredicateContext {
		...
		this.enterRule(localctx, 136, SqlParser.RULE_predicate);
		let _la: number;
		try {
			this.state = 1579;
			this._errHandler.sync(this);
	...
	public query_expression(): Query_expressionContext {
		...
		this.enterRule(localctx, 138, SqlParser.RULE_query_expression);
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
			{
	...
	public sql_union(): Sql_unionContext {
		...
		this.enterRule(localctx, 140, SqlParser.RULE_sql_union);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public query_specification(): Query_specificationContext {
		...
		this.enterRule(localctx, 142, SqlParser.RULE_query_specification);
		let _la: number;
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
	...
	public top_clause(): Top_clauseContext {
		...
		this.enterRule(localctx, 144, SqlParser.RULE_top_clause);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public top_percent(): Top_percentContext {
		...
		this.enterRule(localctx, 146, SqlParser.RULE_top_percent);
		let _la: number;
		try {
			this.state = 1664;
			this._errHandler.sync(this);
	...
	public top_count(): Top_countContext {
		...
		this.enterRule(localctx, 148, SqlParser.RULE_top_count);
		try {
			this.state = 1671;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public order_by_clause(): Order_by_clauseContext {
		...
		this.enterRule(localctx, 150, SqlParser.RULE_order_by_clause);
		let _la: number;
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
	...
	public for_clause(): For_clauseContext {
		...
		this.enterRule(localctx, 152, SqlParser.RULE_for_clause);
		let _la: number;
		try {
			let _alt: number;
			this.state = 1784;
			...
			case 2:
				...
				case 1:
					...
					case 789:
						{
						this.state = 1716;
						this.match(SqlParser.XMLDATA);
						}
						break;
					case 791:
						{
						this.state = 1717;
						this.match(SqlParser.XMLSCHEMA);
						this.state = 1721;
						this._errHandler.sync(this);
			...
			case 5:
				...
				case 1:
					...
					this.match(SqlParser.COMMA);
					this.state = 1777;
					this.match(SqlParser.INCLUDE_NULL_VALUES);
					}
					break;
				}
				this.state = 1782;
				...
				case 1:
					...
					this.match(SqlParser.COMMA);
					this.state = 1781;
					this.match(SqlParser.WITHOUT_ARRAY_WRAPPER);
					}
					break;
				}
				}
	...
	public xml_common_directives(): Xml_common_directivesContext {
		...
		this.enterRule(localctx, 154, SqlParser.RULE_xml_common_directives);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1786;
			...
			case 419:
				{
				this.state = 1787;
				this.match(SqlParser.BINARY_BASE64);
				}
				break;
			case 768:
				{
	...
	public order_by_expression(): Order_by_expressionContext {
		...
		this.enterRule(localctx, 156, SqlParser.RULE_order_by_expression);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public group_by_item(): Group_by_itemContext {
		...
		this.enterRule(localctx, 158, SqlParser.RULE_group_by_item);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1801;
	...
	public option_clause(): Option_clauseContext {
		...
		this.enterRule(localctx, 160, SqlParser.RULE_option_clause);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public option(): OptionContext {
		...
		this.enterRule(localctx, 162, SqlParser.RULE_option);
		let _la: number;
		try {
			this.state = 1860;
			this._errHandler.sync(this);
			...
			case 1:
				...
				this.state = 1816;
				localctx._number_rows = this.match(SqlParser.DECIMAL);
				}
				break;
			case 2:
				this.enterOuterAlt(localctx, 2);
			...
			case 5:
				...
				{
				this.state = 1823;
				this.match(SqlParser.EXPAND);
				this.state = 1824;
				this.match(SqlParser.VIEWS);
				}
				break;
			case 6:
				this.enterOuterAlt(localctx, 6);
			...
			case 7:
				...
				{
				this.state = 1827;
				this.match(SqlParser.IGNORE_NONCLUSTERED_COLUMNSTORE_INDEX);
				}
				break;
			case 8:
				this.enterOuterAlt(localctx, 8);
			...
			case 9:
				...
				{
				this.state = 1830;
				this.match(SqlParser.KEEPFIXED);
				this.state = 1831;
				this.match(SqlParser.PLAN);
				}
				break;
			case 10:
				...
				{
				this.state = 1832;
				this.match(SqlParser.MAXDOP);
				this.state = 1833;
				localctx._number_of_processors = this.match(SqlParser.DECIMAL);
				}
				break;
			case 11:
				this.enterOuterAlt(localctx, 11);
				{
				this.state = 1834;
				this.match(SqlParser.MAXRECURSION);
				this.state = 1835;
				localctx._number_recursion = this.match(SqlParser.DECIMAL);
				}
				break;
			case 12:
				this.enterOuterAlt(localctx, 12);
			...
			case 14:
				...
				{
				this.state = 1852;
				this.match(SqlParser.PARAMETERIZATION);
				this.state = 1853;
				_la = this._input.LA(1);
				if(!(_la===516 || _la===725)) {
				this._errHandler.recoverInline(this);
			...
			case 15:
				...
				{
				this.state = 1854;
				this.match(SqlParser.RECOMPILE);
				}
				break;
			case 16:
	...
	public optimize_for_arg(): Optimize_for_argContext {
		...
		this.enterRule(localctx, 164, SqlParser.RULE_optimize_for_arg);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1862;
	...
	public select_list(): Select_listContext {
		...
		this.enterRule(localctx, 166, SqlParser.RULE_select_list);
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
			{
	...
	public udt_method_arguments(): Udt_method_argumentsContext {
		...
		this.enterRule(localctx, 168, SqlParser.RULE_udt_method_arguments);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public asterisk(): AsteriskContext {
		...
		this.enterRule(localctx, 170, SqlParser.RULE_asterisk);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public column_elem(): Column_elemContext {
		...
		this.enterRule(localctx, 172, SqlParser.RULE_column_elem);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 1910;
	...
	public udt_elem(): Udt_elemContext {
		...
		this.enterRule(localctx, 174, SqlParser.RULE_udt_elem);
		try {
			this.state = 1932;
			this._errHandler.sync(this);
	...
	public expression_elem(): Expression_elemContext {
		...
		this.enterRule(localctx, 176, SqlParser.RULE_expression_elem);
		try {
			this.state = 1942;
			this._errHandler.sync(this);
			...
			case 1:
				...
				this.column_alias();
				this.state = 1935;
				localctx._eq = this.match(SqlParser.EQUAL);
				this.state = 1936;
				this.expression(0);
				}
				break;
	...
	public select_list_elem(): Select_list_elemContext {
		...
		this.enterRule(localctx, 178, SqlParser.RULE_select_list_elem);
		try {
			this.state = 1948;
			this._errHandler.sync(this);
	...
	public table_sources(): Table_sourcesContext {
		...
		this.enterRule(localctx, 180, SqlParser.RULE_table_sources);
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
			{
	...
	public table_source(): Table_sourceContext {
		...
		this.enterRule(localctx, 182, SqlParser.RULE_table_source);
		try {
			this.state = 1963;
			this._errHandler.sync(this);
	...
	public table_source_item_joined(): Table_source_item_joinedContext {
		...
		this.enterRule(localctx, 184, SqlParser.RULE_table_source_item_joined);
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
			{
	...
	public table_source_item(): Table_source_itemContext {
		...
		this.enterRule(localctx, 186, SqlParser.RULE_table_source_item);
		let _la: number;
		try {
			this.state = 2028;
			this._errHandler.sync(this);
	...
	public open_xml(): Open_xmlContext {
		...
		this.enterRule(localctx, 188, SqlParser.RULE_open_xml);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2030;
			this.match(SqlParser.OPENXML);
			this.state = 2031;
			this.match(SqlParser.LR_BRACKET);
			this.state = 2032;
			this.expression(0);
	...
	public schema_declaration(): Schema_declarationContext {
		...
		this.enterRule(localctx, 190, SqlParser.RULE_schema_declaration);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public column_declaration(): Column_declarationContext {
		...
		this.enterRule(localctx, 192, SqlParser.RULE_column_declaration);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public change_table(): Change_tableContext {
		...
		this.enterRule(localctx, 194, SqlParser.RULE_change_table);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2060;
			this.match(SqlParser.CHANGETABLE);
			this.state = 2061;
			this.match(SqlParser.LR_BRACKET);
			this.state = 2062;
			this.match(SqlParser.CHANGES);
			this.state = 2063;
			this.table_name();
			this.state = 2064;
			this.match(SqlParser.COMMA);
	...
	public join_part(): Join_partContext {
		...
		this.enterRule(localctx, 196, SqlParser.RULE_join_part);
		let _la: number;
		try {
			this.state = 2102;
			this._errHandler.sync(this);
	...
	public pivot_clause(): Pivot_clauseContext {
		...
		this.enterRule(localctx, 198, SqlParser.RULE_pivot_clause);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2104;
	...
	public unpivot_clause(): Unpivot_clauseContext {
		...
		this.enterRule(localctx, 200, SqlParser.RULE_unpivot_clause);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2112;
	...
	public full_column_name_list(): Full_column_name_listContext {
		...
		this.enterRule(localctx, 202, SqlParser.RULE_full_column_name_list);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public table_name_with_hint(): Table_name_with_hintContext {
		...
		this.enterRule(localctx, 204, SqlParser.RULE_table_name_with_hint);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2130;
	...
	public rowset_function(): Rowset_functionContext {
		...
		this.enterRule(localctx, 206, SqlParser.RULE_rowset_function);
		let _la: number;
		try {
			this.state = 2160;
			this._errHandler.sync(this);
			...
			case 1:
				...
				{
				this.state = 2134;
				this.match(SqlParser.OPENROWSET);
				this.state = 2135;
				this.match(SqlParser.LR_BRACKET);
				this.state = 2136;
				localctx._provider_name = this.match(SqlParser.STRING);
				this.state = 2137;
				this.match(SqlParser.COMMA);
				this.state = 2138;
				localctx._connectionString = this.match(SqlParser.STRING);
				this.state = 2139;
				this.match(SqlParser.COMMA);
				this.state = 2140;
				localctx._sql = this.match(SqlParser.STRING);
				this.state = 2141;
				this.match(SqlParser.RR_BRACKET);
				}
				}
			...
			case 2:
				...
				this.match(SqlParser.LR_BRACKET);
				this.state = 2144;
				this.match(SqlParser.BULK);
				this.state = 2145;
				localctx._data_file = this.match(SqlParser.STRING);
				this.state = 2146;
				this.match(SqlParser.COMMA);
				this.state = 2156;
				this._errHandler.sync(this);
	...
	public bulk_option(): Bulk_optionContext {
		...
		this.enterRule(localctx, 208, SqlParser.RULE_bulk_option);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public derived_table(): Derived_tableContext {
		...
		this.enterRule(localctx, 210, SqlParser.RULE_derived_table);
		try {
			this.state = 2176;
			this._errHandler.sync(this);
	...
	public function_call(): Function_callContext {
		...
		this.enterRule(localctx, 212, SqlParser.RULE_function_call);
		let _la: number;
		try {
			this.state = 2324;
			this._errHandler.sync(this);
			...
			case 1:
				...
				{
				this.state = 2178;
				this.match(SqlParser.BINARY_CHECKSUM);
				this.state = 2179;
				this.match(SqlParser.LR_BRACKET);
				this.state = 2180;
				this.match(SqlParser.STAR);
			...
			case 13:
				...
				{
				this.state = 2246;
				this.match(SqlParser.GETUTCDATE);
				this.state = 2247;
				this.match(SqlParser.LR_BRACKET);
				this.state = 2248;
				this.match(SqlParser.RR_BRACKET);
			...
			case 14:
				...
				case 1:
					...
					this.match(SqlParser.COMMA);
					this.state = 2253;
					(localctx as IDENTITYContext)._seed = this.match(SqlParser.DECIMAL);
					}
					break;
				}
				this.state = 2258;
				...
				if (_la===838) {
					...
					this.match(SqlParser.COMMA);
					this.state = 2257;
					(localctx as IDENTITYContext)._increment = this.match(SqlParser.DECIMAL);
					}
				}
			...
			case 15:
				...
				{
				this.state = 2262;
				this.match(SqlParser.MIN_ACTIVE_ROWVERSION);
				}
				break;
			case 16:
			...
			case 18:
				...
				{
				this.state = 2281;
				this.match(SqlParser.SESSION_USER);
				}
				break;
			case 19:
				...
				{
				this.state = 2282;
				this.match(SqlParser.SYSTEM_USER);
				}
				break;
			case 20:
			...
			case 27:
				...
				{
				this.state = 2310;
				this.match(SqlParser.STRING_AGG);
				this.state = 2311;
				this.match(SqlParser.LR_BRACKET);
				this.state = 2312;
	...
	public xml_data_type_methods(): Xml_data_type_methodsContext {
		...
		this.enterRule(localctx, 214, SqlParser.RULE_xml_data_type_methods);
		try {
			this.state = 2331;
			this._errHandler.sync(this);
	...
	public value_method(): Value_methodContext {
		...
		this.enterRule(localctx, 216, SqlParser.RULE_value_method);
		try {
			this.state = 2376;
			this._errHandler.sync(this);
			...
			case 1:
				...
				case 3:
					{
					this.state = 2335;
					this.match(SqlParser.EVENTDATA);
					}
					break;
				case 4:
					{
				...
				this.match(SqlParser.LR_BRACKET);
				this.state = 2342;
				localctx._xquery = this.match(SqlParser.STRING);
				this.state = 2343;
				this.match(SqlParser.COMMA);
				this.state = 2344;
				localctx._sqltype = this.match(SqlParser.STRING);
				this.state = 2345;
				this.match(SqlParser.RR_BRACKET);
				}
				break;
			...
			case 3:
				...
				this.match(SqlParser.DOT);
				this.state = 2368;
				this.match(SqlParser.PARAM_NODE);
				this.state = 2369;
				this.match(SqlParser.DOT);
				this.state = 2370;
				this.match(SqlParser.VALUE);
	...
	public query_method(): Query_methodContext {
		...
		this.enterRule(localctx, 218, SqlParser.RULE_query_method);
		try {
			this.state = 2400;
			this._errHandler.sync(this);
	...
	public exist_method(): Exist_methodContext {
		...
		this.enterRule(localctx, 220, SqlParser.RULE_exist_method);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public modify_method(): Modify_methodContext {
		...
		this.enterRule(localctx, 222, SqlParser.RULE_modify_method);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
			...
			this.match(SqlParser.LR_BRACKET);
			this.state = 2413;
			localctx._xml_dml = this.match(SqlParser.STRING);
			this.state = 2414;
			this.match(SqlParser.RR_BRACKET);
			}
		}
	...
	public nodes_method(): Nodes_methodContext {
		...
		this.enterRule(localctx, 224, SqlParser.RULE_nodes_method);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public switch_section(): Switch_sectionContext {
		...
		this.enterRule(localctx, 226, SqlParser.RULE_switch_section);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2423;
	...
	public switch_search_condition_section(): Switch_search_condition_sectionContext {
		...
		this.enterRule(localctx, 228, SqlParser.RULE_switch_search_condition_section);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2428;
	...
	public as_column_alias(): As_column_aliasContext {
		...
		this.enterRule(localctx, 230, SqlParser.RULE_as_column_alias);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public as_table_alias(): As_table_aliasContext {
		...
		this.enterRule(localctx, 232, SqlParser.RULE_as_table_alias);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public table_alias(): Table_aliasContext {
		...
		this.enterRule(localctx, 234, SqlParser.RULE_table_alias);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2443;
	...
	public with_table_hints(): With_table_hintsContext {
		...
		this.enterRule(localctx, 236, SqlParser.RULE_with_table_hints);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public insert_with_table_hints(): Insert_with_table_hintsContext {
		...
		this.enterRule(localctx, 238, SqlParser.RULE_insert_with_table_hints);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public table_hint(): Table_hintContext {
		...
		this.enterRule(localctx, 240, SqlParser.RULE_table_hint);
		let _la: number;
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
			...
			case 3:
				{
				this.state = 2505;
				this.match(SqlParser.FORCESEEK);
				this.state = 2520;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (_la===836) {
			...
			case 6:
				{
				this.state = 2524;
				this.match(SqlParser.SPATIAL_WINDOW_MAX_CELLS);
				this.state = 2525;
				this.match(SqlParser.EQUAL);
				this.state = 2526;
				this.match(SqlParser.DECIMAL);
	...
	public index_value(): Index_valueContext {
		...
		this.enterRule(localctx, 242, SqlParser.RULE_index_value);
		try {
			this.state = 2532;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public column_alias_list(): Column_alias_listContext {
		...
		this.enterRule(localctx, 244, SqlParser.RULE_column_alias_list);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public column_alias(): Column_aliasContext {
		...
		this.enterRule(localctx, 246, SqlParser.RULE_column_alias);
		try {
			this.state = 2547;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public table_value_constructor(): Table_value_constructorContext {
		...
		this.enterRule(localctx, 248, SqlParser.RULE_table_value_constructor);
		try {
			let _alt: number;
			this.enterOuterAlt(localctx, 1);
			{
	...
	public expression_list(): Expression_listContext {
		...
		this.enterRule(localctx, 250, SqlParser.RULE_expression_list);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public ranking_windowed_function(): Ranking_windowed_functionContext {
		...
		this.enterRule(localctx, 252, SqlParser.RULE_ranking_windowed_function);
		let _la: number;
		try {
			this.state = 2581;
			this._errHandler.sync(this);
	...
	public aggregate_windowed_function(): Aggregate_windowed_functionContext {
		...
		this.enterRule(localctx, 254, SqlParser.RULE_aggregate_windowed_function);
		let _la: number;
		try {
			this.state = 2615;
			this._errHandler.sync(this);
			...
			case 434:
				...
				{
				this.state = 2600;
				this.match(SqlParser.CHECKSUM_AGG);
				this.state = 2601;
				this.match(SqlParser.LR_BRACKET);
				this.state = 2602;
				this.all_distinct_expression();
			...
			case 528:
				...
				{
				this.state = 2610;
				this.match(SqlParser.GROUPING_ID);
				this.state = 2611;
				this.match(SqlParser.LR_BRACKET);
				this.state = 2612;
				this.expression_list();
	...
	public analytic_windowed_function(): Analytic_windowed_functionContext {
		...
		this.enterRule(localctx, 256, SqlParser.RULE_analytic_windowed_function);
		let _la: number;
		try {
			this.state = 2637;
			this._errHandler.sync(this);
	...
	public all_distinct_expression(): All_distinct_expressionContext {
		...
		this.enterRule(localctx, 258, SqlParser.RULE_all_distinct_expression);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public over_clause(): Over_clauseContext {
		...
		this.enterRule(localctx, 260, SqlParser.RULE_over_clause);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public row_or_range_clause(): Row_or_range_clauseContext {
		...
		this.enterRule(localctx, 262, SqlParser.RULE_row_or_range_clause);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public window_frame_extent(): Window_frame_extentContext {
		...
		this.enterRule(localctx, 264, SqlParser.RULE_window_frame_extent);
		try {
			this.state = 2668;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public window_frame_bound(): Window_frame_boundContext {
		...
		this.enterRule(localctx, 266, SqlParser.RULE_window_frame_bound);
		try {
			this.state = 2672;
			this._errHandler.sync(this);
	...
	public window_frame_preceding(): Window_frame_precedingContext {
		...
		this.enterRule(localctx, 268, SqlParser.RULE_window_frame_preceding);
		try {
			this.state = 2680;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public window_frame_following(): Window_frame_followingContext {
		...
		this.enterRule(localctx, 270, SqlParser.RULE_window_frame_following);
		try {
			this.state = 2686;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public full_table_name(): Full_table_nameContext {
		...
		this.enterRule(localctx, 272, SqlParser.RULE_full_table_name);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public table_name(): Table_nameContext {
		...
		this.enterRule(localctx, 274, SqlParser.RULE_table_name);
		let _la: number;
		try {
			this.state = 2735;
			this._errHandler.sync(this);
	...
	public simple_name(): Simple_nameContext {
		...
		this.enterRule(localctx, 276, SqlParser.RULE_simple_name);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2740;
	...
	public func_proc_name_schema(): Func_proc_name_schemaContext {
		...
		this.enterRule(localctx, 278, SqlParser.RULE_func_proc_name_schema);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2747;
	...
	public func_proc_name_database_schema(): Func_proc_name_database_schemaContext {
		...
		this.enterRule(localctx, 280, SqlParser.RULE_func_proc_name_database_schema);
		let _la: number;
		try {
			this.state = 2762;
			this._errHandler.sync(this);
	...
	public func_proc_name_server_database_schema(): Func_proc_name_server_database_schemaContext {
		...
		this.enterRule(localctx, 282, SqlParser.RULE_func_proc_name_server_database_schema);
		let _la: number;
		try {
			this.state = 2777;
			this._errHandler.sync(this);
	...
	public ddl_object(): Ddl_objectContext {
		...
		this.enterRule(localctx, 284, SqlParser.RULE_ddl_object);
		try {
			this.state = 2781;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public full_column_name(): Full_column_nameContext {
		...
		this.enterRule(localctx, 286, SqlParser.RULE_full_column_name);
		try {
			this.state = 2831;
			this._errHandler.sync(this);
			...
			case 2:
				...
				this.state = 2794;
				this.match(SqlParser.COMPATIBILITY_LEVEL);
				}
				break;
			case 3:
				this.enterOuterAlt(localctx, 3);
			...
			case 5:
				...
				this.state = 2812;
				this.match(SqlParser.ARITHABORT);
				}
				break;
			case 6:
				this.enterOuterAlt(localctx, 6);
				...
				this.state = 2818;
				this.match(SqlParser.ANSI_WARNINGS);
				}
				break;
			case 7:
				this.enterOuterAlt(localctx, 7);
				...
				this.state = 2824;
				this.match(SqlParser.ANSI_PADDING);
				}
				break;
			case 8:
				this.enterOuterAlt(localctx, 8);
				...
				this.state = 2830;
				this.match(SqlParser.ANSI_NULLS);
				}
				break;
			}
		}
	...
	public column_name_list_with_order(): Column_name_list_with_orderContext {
		...
		this.enterRule(localctx, 288, SqlParser.RULE_column_name_list_with_order);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public column_name_list(): Column_name_listContext {
		...
		this.enterRule(localctx, 290, SqlParser.RULE_column_name_list);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public cursor_name(): Cursor_nameContext {
		...
		this.enterRule(localctx, 292, SqlParser.RULE_cursor_name);
		try {
			this.state = 2857;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public on_off(): On_offContext {
		...
		this.enterRule(localctx, 294, SqlParser.RULE_on_off);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public clustered(): ClusteredContext {
		...
		this.enterRule(localctx, 296, SqlParser.RULE_clustered);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public null_notnull(): Null_notnullContext {
		...
		this.enterRule(localctx, 298, SqlParser.RULE_null_notnull);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public null_or_default(): Null_or_defaultContext {
		...
		this.enterRule(localctx, 300, SqlParser.RULE_null_or_default);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 2875;
	...
	public scalar_function_name(): Scalar_function_nameContext {
		...
		this.enterRule(localctx, 302, SqlParser.RULE_scalar_function_name);
		try {
			this.state = 2882;
			this._errHandler.sync(this);
	...
	public data_type(): Data_typeContext {
		...
		this.enterRule(localctx, 304, SqlParser.RULE_data_type);
		let _la: number;
		try {
			this.state = 2905;
			this._errHandler.sync(this);
	...
	public constant(): ConstantContext {
		...
		this.enterRule(localctx, 306, SqlParser.RULE_constant);
		let _la: number;
		try {
			this.state = 2922;
			this._errHandler.sync(this);
			...
			case 5:
				...
				this.state = 2920;
				localctx._dollar = this.match(SqlParser.DOLLAR);
				this.state = 2921;
				_la = this._input.LA(1);
				if(!(_la===807 || _la===813)) {
				this._errHandler.recoverInline(this);
	...
	public sign(): SignContext {
		...
		this.enterRule(localctx, 308, SqlParser.RULE_sign);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public id(): IdContext {
		...
		this.enterRule(localctx, 310, SqlParser.RULE_id);
		try {
			this.state = 2929;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			...
			case 801:
				...
				{
				this.state = 2928;
				this.match(SqlParser.SQUARE_BRACKET_ID);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public simple_id(): Simple_idContext {
		...
		this.enterRule(localctx, 312, SqlParser.RULE_simple_id);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public comparison_operator(): Comparison_operatorContext {
		...
		this.enterRule(localctx, 314, SqlParser.RULE_comparison_operator);
		try {
			this.state = 2943;
			this._errHandler.sync(this);
			...
			case 4:
				...
				{
				this.state = 2936;
				this.match(SqlParser.LESS_EQUAL);
				}
				break;
			case 5:
				this.enterOuterAlt(localctx, 5);
				{
				this.state = 2937;
				this.match(SqlParser.GREATER_EQUAL);
				}
				break;
			case 6:
				this.enterOuterAlt(localctx, 6);
				{
				this.state = 2938;
				this.match(SqlParser.NOT_EQUAL);
				}
				break;
			case 7:
				this.enterOuterAlt(localctx, 7);
				{
				this.state = 2939;
				this.match(SqlParser.EXCLAMATION);
				this.state = 2940;
				this.match(SqlParser.GREATER);
				}
				break;
	...
	public assignment_operator(): Assignment_operatorContext {
		...
		this.enterRule(localctx, 316, SqlParser.RULE_assignment_operator);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
...
export class Sql_scriptContext extends ParserRuleContext {
	...
	public enterRule(listener: SqlListener): void {
	    if(listener.enterSql_script) {
	 		listener.enterSql_script(this);
		}
	}
	public exitRule(listener: SqlListener): void {
...
export class Sql_clausesContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_sql_clauses;
	}
	public enterRule(listener: SqlListener): void {
...
export class Sql_clauseContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_sql_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class Dml_clauseContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_dml_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class Ddl_clauseContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_ddl_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class Drop_sequenceContext extends ParserRuleContext {
	...
	public SEQUENCE(): TerminalNode {
		return this.getToken(SqlParser.SEQUENCE, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_drop_sequence;
	}
	public enterRule(listener: SqlListener): void {
...
export class Alter_sequenceContext extends ParserRuleContext {
	...
	public RESTART(): TerminalNode {
		return this.getToken(SqlParser.RESTART, 0);
	}
	public INCREMENT(): TerminalNode {
		return this.getToken(SqlParser.INCREMENT, 0);
	}
	public BY(): TerminalNode {
		return this.getToken(SqlParser.BY, 0);
	}
	public MINVALUE(): TerminalNode {
		return this.getToken(SqlParser.MINVALUE, 0);
	}
	public DECIMAL_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.DECIMAL);
	}
	public DECIMAL(i: number): TerminalNode {
		return this.getToken(SqlParser.DECIMAL, i);
	}
	...
	public CYCLE(): TerminalNode {
		return this.getToken(SqlParser.CYCLE, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_alter_sequence;
	}
	public enterRule(listener: SqlListener): void {
...
export class Create_sequenceContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_create_sequence;
	}
	public enterRule(listener: SqlListener): void {
...
export class Delete_statementContext extends ParserRuleContext {
	...
	public TOP(): TerminalNode {
		return this.getToken(SqlParser.TOP, 0);
	}
...
export class Delete_statement_fromContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_delete_statement_from;
	}
	public enterRule(listener: SqlListener): void {
...
export class Insert_statement_valueContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_insert_statement_value;
	}
	public enterRule(listener: SqlListener): void {
...
export class Output_clauseContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_output_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class Output_dml_list_elemContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_output_dml_list_elem;
	}
	public enterRule(listener: SqlListener): void {
...
export class Output_column_nameContext extends ParserRuleContext {
	...
	public DELETED(): TerminalNode {
		return this.getToken(SqlParser.DELETED, 0);
	}
	public INSERTED(): TerminalNode {
		return this.getToken(SqlParser.INSERTED, 0);
	}
	public table_name(): Table_nameContext {
		return this.getTypedRuleContext(Table_nameContext, 0) as Table_nameContext;
	}
	...
	public DOLLAR_ACTION(): TerminalNode {
		return this.getToken(SqlParser.DOLLAR_ACTION, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_output_column_name;
	}
	public enterRule(listener: SqlListener): void {
...
export class Create_indexContext extends ParserRuleContext {
	...
	public INCLUDE(): TerminalNode {
		return this.getToken(SqlParser.INCLUDE, 0);
	}
	public column_name_list(): Column_name_listContext {
		return this.getTypedRuleContext(Column_name_listContext, 0) as Column_name_listContext;
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_create_index;
	}
	public enterRule(listener: SqlListener): void {
...
export class Create_tableContext extends ParserRuleContext {
	...
	public TEXTIMAGE_ON(): TerminalNode {
		return this.getToken(SqlParser.TEXTIMAGE_ON, 0);
	}
	public SEMI(): TerminalNode {
		return this.getToken(SqlParser.SEMI, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_create_table;
	}
	public enterRule(listener: SqlListener): void {
...
export class Table_optionsContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_table_options;
	}
	public enterRule(listener: SqlListener): void {
...
export class Create_viewContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_create_view;
	}
	public enterRule(listener: SqlListener): void {
...
export class View_attributeContext extends ParserRuleContext {
	...
	public SCHEMABINDING(): TerminalNode {
		return this.getToken(SqlParser.SCHEMABINDING, 0);
	}
	public VIEW_METADATA(): TerminalNode {
		return this.getToken(SqlParser.VIEW_METADATA, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_view_attribute;
	}
	public enterRule(listener: SqlListener): void {
...
export class Alter_tableContext extends ParserRuleContext {
	...
	public TABLE_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.TABLE);
	}
	public TABLE(i: number): TerminalNode {
		return this.getToken(SqlParser.TABLE, i);
	}
	...
	public LOCK_ESCALATION(): TerminalNode {
		return this.getToken(SqlParser.LOCK_ESCALATION, 0);
	}
	...
	public AUTO(): TerminalNode {
		return this.getToken(SqlParser.AUTO, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_alter_table;
	}
	public enterRule(listener: SqlListener): void {
...
export class Drop_indexContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_drop_index;
	}
	public enterRule(listener: SqlListener): void {
...
export class Drop_relational_or_xml_or_spatial_indexContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_drop_relational_or_xml_or_spatial_index;
	}
	public enterRule(listener: SqlListener): void {
...
export class Drop_backward_compatible_indexContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_drop_backward_compatible_index;
	}
	public enterRule(listener: SqlListener): void {
...
export class Drop_tableContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_drop_table;
	}
	public enterRule(listener: SqlListener): void {
...
export class Drop_viewContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_drop_view;
	}
	public enterRule(listener: SqlListener): void {
...
export class Rowset_function_limitedContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_rowset_function_limited;
	}
	public enterRule(listener: SqlListener): void {
...
export class OpenqueryContext extends ParserRuleContext {
	...
	public OPENQUERY(): TerminalNode {
		return this.getToken(SqlParser.OPENQUERY, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_openquery;
	}
	public enterRule(listener: SqlListener): void {
...
export class OpendatasourceContext extends ParserRuleContext {
	...
	public OPENDATASOURCE(): TerminalNode {
		return this.getToken(SqlParser.OPENDATASOURCE, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_opendatasource;
	}
	public enterRule(listener: SqlListener): void {
...
export class Execute_bodyContext extends ParserRuleContext {
	...
	public LOGIN(): TerminalNode {
		return this.getToken(SqlParser.LOGIN, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_execute_body;
	}
	public enterRule(listener: SqlListener): void {
...
export class Execute_statement_argContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_execute_statement_arg;
	}
	public enterRule(listener: SqlListener): void {
...
export class Execute_var_stringContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_execute_var_string;
	}
	public enterRule(listener: SqlListener): void {
...
export class Column_def_table_constraintsContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_column_def_table_constraints;
	}
	public enterRule(listener: SqlListener): void {
...
export class Column_def_table_constraintContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_column_def_table_constraint;
	}
	public enterRule(listener: SqlListener): void {
...
export class Column_definitionContext extends ParserRuleContext {
	...
	public IDENTITY(): TerminalNode {
		return this.getToken(SqlParser.IDENTITY, 0);
	}
	public ROWGUIDCOL(): TerminalNode {
		return this.getToken(SqlParser.ROWGUIDCOL, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_column_definition;
	}
	public enterRule(listener: SqlListener): void {
...
export class Materialized_column_definitionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_materialized_column_definition;
	}
	public enterRule(listener: SqlListener): void {
...
export class On_deleteContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_on_delete;
	}
	public enterRule(listener: SqlListener): void {
...
export class On_updateContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_on_update;
	}
	public enterRule(listener: SqlListener): void {
...
export class Index_optionsContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_index_options;
	}
	public enterRule(listener: SqlListener): void {
...
export class Index_optionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_index_option;
	}
	public enterRule(listener: SqlListener): void {
...
export class Constant_LOCAL_IDContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_constant_LOCAL_ID;
	}
	public enterRule(listener: SqlListener): void {
...
export class ExpressionContext extends ParserRuleContext {
	...
	public DOUBLE_BAR(): TerminalNode {
		return this.getToken(SqlParser.DOUBLE_BAR, 0);
	}
	public comparison_operator(): Comparison_operatorContext {
...
export class Moca_at_variableContext extends ParserRuleContext {
	...
	public SHARP(): TerminalNode {
		return this.getToken(SqlParser.SHARP, 0);
	}
	public KEEP(): TerminalNode {
		return this.getToken(SqlParser.KEEP, 0);
	}
	public MOCA_ONSTACK(): TerminalNode {
		return this.getToken(SqlParser.MOCA_ONSTACK, 0);
	}
	public MOCA_IGNORE(): TerminalNode {
		return this.getToken(SqlParser.MOCA_IGNORE, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_moca_at_variable;
	}
	public enterRule(listener: SqlListener): void {
...
export class Moca_environment_variableContext extends ParserRuleContext {
	...
	public MOCA_ENVIRONMENT_VARIABLE(): TerminalNode {
		return this.getToken(SqlParser.MOCA_ENVIRONMENT_VARIABLE, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_moca_environment_variable;
	}
	public enterRule(listener: SqlListener): void {
...
export class Moca_at_minus_variableContext extends ParserRuleContext {
	...
	public MOCA_AT_MINUS_VARIABLE(): TerminalNode {
		return this.getToken(SqlParser.MOCA_AT_MINUS_VARIABLE, 0);
	}
	public DOT(): TerminalNode {
		return this.getToken(SqlParser.DOT, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_moca_at_minus_variable;
	}
	public enterRule(listener: SqlListener): void {
...
export class Moca_at_plus_variableContext extends ParserRuleContext {
	...
	public MOCA_AT_PLUS_VARIABLE(): TerminalNode {
		return this.getToken(SqlParser.MOCA_AT_PLUS_VARIABLE, 0);
	}
	public DOT(): TerminalNode {
		return this.getToken(SqlParser.DOT, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_moca_at_plus_variable;
	}
	public enterRule(listener: SqlListener): void {
...
export class Moca_at_starContext extends ParserRuleContext {
	...
	public MOCA_AT_STAR(): TerminalNode {
		return this.getToken(SqlParser.MOCA_AT_STAR, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_moca_at_star;
	}
	public enterRule(listener: SqlListener): void {
...
export class Moca_integration_variableContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_moca_integration_variable;
	}
	public enterRule(listener: SqlListener): void {
...
export class Primitive_expressionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_primitive_expression;
	}
	public enterRule(listener: SqlListener): void {
...
export class Unary_operator_expressionContext extends ParserRuleContext {
	...
	public BIT_NOT(): TerminalNode {
		return this.getToken(SqlParser.BIT_NOT, 0);
	}
	public expression(): ExpressionContext {
		return this.getTypedRuleContext(ExpressionContext, 0) as ExpressionContext;
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_unary_operator_expression;
	}
	public enterRule(listener: SqlListener): void {
...
export class Bracket_expressionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_bracket_expression;
	}
	public enterRule(listener: SqlListener): void {
...
export class Constant_expressionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_constant_expression;
	}
	public enterRule(listener: SqlListener): void {
...
export class With_expressionContext extends ParserRuleContext {
	...
	public XMLNAMESPACES(): TerminalNode {
		return this.getToken(SqlParser.XMLNAMESPACES, 0);
	}
	public COMMA_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.COMMA);
	}
	...
	public BLOCKING_HIERARCHY(): TerminalNode {
		return this.getToken(SqlParser.BLOCKING_HIERARCHY, 0);
	}
	public AS(): TerminalNode {
		return this.getToken(SqlParser.AS, 0);
	}
...
export class Update_elemContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_update_elem;
	}
	public enterRule(listener: SqlListener): void {
...
export class Search_condition_listContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_search_condition_list;
	}
	public enterRule(listener: SqlListener): void {
...
export class Search_condition_andContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_search_condition_and;
	}
	public enterRule(listener: SqlListener): void {
...
export class Search_condition_notContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_search_condition_not;
	}
	public enterRule(listener: SqlListener): void {
...
export class PredicateContext extends ParserRuleContext {
	...
	public RAW(): TerminalNode {
		return this.getToken(SqlParser.RAW, 0);
	}
	public DOT(): TerminalNode {
		return this.getToken(SqlParser.DOT, 0);
	}
...
export class Sql_unionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_sql_union;
	}
	public enterRule(listener: SqlListener): void {
...
export class Top_clauseContext extends ParserRuleContext {
	...
	public TIES(): TerminalNode {
		return this.getToken(SqlParser.TIES, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_top_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class Top_percentContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_top_percent;
	}
	public enterRule(listener: SqlListener): void {
...
export class Top_countContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_top_count;
	}
	public enterRule(listener: SqlListener): void {
...
export class Order_by_clauseContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_order_by_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class For_clauseContext extends ParserRuleContext {
	...
	public BROWSE(): TerminalNode {
		return this.getToken(SqlParser.BROWSE, 0);
	}
	...
	public ELEMENTS(): TerminalNode {
		return this.getToken(SqlParser.ELEMENTS, 0);
	}
	public XSINIL(): TerminalNode {
		return this.getToken(SqlParser.XSINIL, 0);
	}
	public ABSENT(): TerminalNode {
		return this.getToken(SqlParser.ABSENT, 0);
	}
	public LR_BRACKET_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.LR_BRACKET);
	}
	...
	public XMLDATA(): TerminalNode {
		return this.getToken(SqlParser.XMLDATA, 0);
	}
	public XMLSCHEMA(): TerminalNode {
		return this.getToken(SqlParser.XMLSCHEMA, 0);
	}
	public EXPLICIT(): TerminalNode {
		return this.getToken(SqlParser.EXPLICIT, 0);
	}
	public PATH(): TerminalNode {
		return this.getToken(SqlParser.PATH, 0);
	}
	public JSON(): TerminalNode {
		return this.getToken(SqlParser.JSON, 0);
	}
	public ROOT(): TerminalNode {
		return this.getToken(SqlParser.ROOT, 0);
	}
	public INCLUDE_NULL_VALUES(): TerminalNode {
		return this.getToken(SqlParser.INCLUDE_NULL_VALUES, 0);
	}
	public WITHOUT_ARRAY_WRAPPER(): TerminalNode {
		return this.getToken(SqlParser.WITHOUT_ARRAY_WRAPPER, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_for_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class Xml_common_directivesContext extends ParserRuleContext {
	...
	public BINARY_BASE64(): TerminalNode {
		return this.getToken(SqlParser.BINARY_BASE64, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_xml_common_directives;
	}
	public enterRule(listener: SqlListener): void {
...
export class Order_by_expressionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_order_by_expression;
	}
	public enterRule(listener: SqlListener): void {
...
export class Group_by_itemContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_group_by_item;
	}
	public enterRule(listener: SqlListener): void {
...
export class Option_clauseContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_option_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class OptionContext extends ParserRuleContext {
	...
	public LOOP(): TerminalNode {
		return this.getToken(SqlParser.LOOP, 0);
	}
	public EXPAND(): TerminalNode {
		return this.getToken(SqlParser.EXPAND, 0);
	}
	public VIEWS(): TerminalNode {
		return this.getToken(SqlParser.VIEWS, 0);
	}
	public FORCE(): TerminalNode {
		return this.getToken(SqlParser.FORCE, 0);
	}
	public IGNORE_NONCLUSTERED_COLUMNSTORE_INDEX(): TerminalNode {
		return this.getToken(SqlParser.IGNORE_NONCLUSTERED_COLUMNSTORE_INDEX, 0);
	}
	public KEEP(): TerminalNode {
		return this.getToken(SqlParser.KEEP, 0);
	}
	public PLAN(): TerminalNode {
		return this.getToken(SqlParser.PLAN, 0);
	}
	public KEEPFIXED(): TerminalNode {
		return this.getToken(SqlParser.KEEPFIXED, 0);
	}
	public MAXDOP(): TerminalNode {
		return this.getToken(SqlParser.MAXDOP, 0);
	}
	public MAXRECURSION(): TerminalNode {
		return this.getToken(SqlParser.MAXRECURSION, 0);
	}
	...
	public PARAMETERIZATION(): TerminalNode {
		return this.getToken(SqlParser.PARAMETERIZATION, 0);
	}
	public SIMPLE(): TerminalNode {
		return this.getToken(SqlParser.SIMPLE, 0);
	}
	public FORCED(): TerminalNode {
		return this.getToken(SqlParser.FORCED, 0);
	}
	public RECOMPILE(): TerminalNode {
		return this.getToken(SqlParser.RECOMPILE, 0);
	}
	public ROBUST(): TerminalNode {
		return this.getToken(SqlParser.ROBUST, 0);
	}
...
export class Optimize_for_argContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_optimize_for_arg;
	}
	public enterRule(listener: SqlListener): void {
...
export class Udt_method_argumentsContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_udt_method_arguments;
	}
	public enterRule(listener: SqlListener): void {
...
export class AsteriskContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_asterisk;
	}
	public enterRule(listener: SqlListener): void {
...
export class Column_elemContext extends ParserRuleContext {
	...
	public DOLLAR(): TerminalNode {
		return this.getToken(SqlParser.DOLLAR, 0);
	}
	public IDENTITY(): TerminalNode {
		return this.getToken(SqlParser.IDENTITY, 0);
	}
	public ROWGUID(): TerminalNode {
		return this.getToken(SqlParser.ROWGUID, 0);
	}
	public table_name(): Table_nameContext {
		return this.getTypedRuleContext(Table_nameContext, 0) as Table_nameContext;
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_column_elem;
	}
	public enterRule(listener: SqlListener): void {
...
export class Udt_elemContext extends ParserRuleContext {
	...
	public COLON_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.COLON);
	}
	public COLON(i: number): TerminalNode {
		return this.getToken(SqlParser.COLON, i);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_udt_elem;
	}
	public enterRule(listener: SqlListener): void {
...
export class Expression_elemContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_expression_elem;
	}
	public enterRule(listener: SqlListener): void {
...
export class Select_list_elemContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_select_list_elem;
	}
	public enterRule(listener: SqlListener): void {
...
export class Table_sourcesContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_table_sources;
	}
	public enterRule(listener: SqlListener): void {
...
export class Table_source_item_joinedContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_table_source_item_joined;
	}
	public enterRule(listener: SqlListener): void {
...
export class Table_source_itemContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_table_source_item;
	}
	public enterRule(listener: SqlListener): void {
...
export class Open_xmlContext extends ParserRuleContext {
	...
	public OPENXML(): TerminalNode {
		return this.getToken(SqlParser.OPENXML, 0);
	}
	public LR_BRACKET_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.LR_BRACKET);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_open_xml;
	}
	public enterRule(listener: SqlListener): void {
...
export class Schema_declarationContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_schema_declaration;
	}
	public enterRule(listener: SqlListener): void {
...
export class Column_declarationContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_column_declaration;
	}
	public enterRule(listener: SqlListener): void {
...
export class Change_tableContext extends ParserRuleContext {
	...
	public CHANGETABLE(): TerminalNode {
		return this.getToken(SqlParser.CHANGETABLE, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
	public CHANGES(): TerminalNode {
		return this.getToken(SqlParser.CHANGES, 0);
	}
	public table_name(): Table_nameContext {
		return this.getTypedRuleContext(Table_nameContext, 0) as Table_nameContext;
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_change_table;
	}
	public enterRule(listener: SqlListener): void {
...
export class Join_partContext extends ParserRuleContext {
	...
	public UNPIVOT(): TerminalNode {
		return this.getToken(SqlParser.UNPIVOT, 0);
	}
	public unpivot_clause(): Unpivot_clauseContext {
...
export class Pivot_clauseContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_pivot_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class Unpivot_clauseContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_unpivot_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class Full_column_name_listContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_full_column_name_list;
	}
	public enterRule(listener: SqlListener): void {
...
export class Table_name_with_hintContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_table_name_with_hint;
	}
	public enterRule(listener: SqlListener): void {
...
export class Rowset_functionContext extends ParserRuleContext {
	...
	public OPENROWSET(): TerminalNode {
		return this.getToken(SqlParser.OPENROWSET, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
	...
	public BULK(): TerminalNode {
		return this.getToken(SqlParser.BULK, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_rowset_function;
	}
	public enterRule(listener: SqlListener): void {
...
export class Bulk_optionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_bulk_option;
	}
	public enterRule(listener: SqlListener): void {
...
export class CURRENT_USERContext extends Function_callContext {
	constructor(parser: SqlParser, ctx: Function_callContext) {
...
export class DATEADDContext extends Function_callContext {
	...
	public DATEADD(): TerminalNode {
		return this.getToken(SqlParser.DATEADD, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
...
export class BINARY_CHECKSUMContext extends Function_callContext {
	...
	public BINARY_CHECKSUM(): TerminalNode {
		return this.getToken(SqlParser.BINARY_CHECKSUM, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
...
export class IFFContext extends Function_callContext {
	...
	public IIF(): TerminalNode {
		return this.getToken(SqlParser.IIF, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
...
export class MIN_ACTIVE_ROWVERSIONContext extends Function_callContext {
	...
	public MIN_ACTIVE_ROWVERSION(): TerminalNode {
		return this.getToken(SqlParser.MIN_ACTIVE_ROWVERSION, 0);
	}
	public enterRule(listener: SqlListener): void {
...
export class DATEPARTContext extends Function_callContext {
	...
	public DATEPART(): TerminalNode {
		return this.getToken(SqlParser.DATEPART, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
...
export class STUFFContext extends Function_callContext {
	...
	public STUFF(): TerminalNode {
		return this.getToken(SqlParser.STUFF, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
...
export class DATENAMEContext extends Function_callContext {
	...
	public DATENAME(): TerminalNode {
		return this.getToken(SqlParser.DATENAME, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
...
export class GETUTCDATEContext extends Function_callContext {
	...
	public GETUTCDATE(): TerminalNode {
		return this.getToken(SqlParser.GETUTCDATE, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
...
export class GETDATEContext extends Function_callContext {
	...
	public GETDATE(): TerminalNode {
		return this.getToken(SqlParser.GETDATE, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
...
export class STRINGAGGContext extends Function_callContext {
	...
	public STRING_AGG(): TerminalNode {
		return this.getToken(SqlParser.STRING_AGG, 0);
	}
	public LR_BRACKET_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.LR_BRACKET);
	}
...
export class Xml_data_type_methodsContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_xml_data_type_methods;
	}
	public enterRule(listener: SqlListener): void {
...
export class Value_methodContext extends ParserRuleContext {
	...
	public EVENTDATA(): TerminalNode {
		return this.getToken(SqlParser.EVENTDATA, 0);
	}
	public query_method(): Query_methodContext {
		return this.getTypedRuleContext(Query_methodContext, 0) as Query_methodContext;
	}
	...
	public PARAM_NODE(): TerminalNode {
		return this.getToken(SqlParser.PARAM_NODE, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_value_method;
	}
	public enterRule(listener: SqlListener): void {
...
export class Query_methodContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_query_method;
	}
	public enterRule(listener: SqlListener): void {
...
export class Exist_methodContext extends ParserRuleContext {
	...
	public EXIST(): TerminalNode {
		return this.getToken(SqlParser.EXIST, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_exist_method;
	}
	public enterRule(listener: SqlListener): void {
...
export class Modify_methodContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_modify_method;
	}
	public enterRule(listener: SqlListener): void {
...
export class Nodes_methodContext extends ParserRuleContext {
	...
	public NODES(): TerminalNode {
		return this.getToken(SqlParser.NODES, 0);
	}
	public LR_BRACKET(): TerminalNode {
		return this.getToken(SqlParser.LR_BRACKET, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_nodes_method;
	}
	public enterRule(listener: SqlListener): void {
...
export class Switch_sectionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_switch_section;
	}
	public enterRule(listener: SqlListener): void {
...
export class Switch_search_condition_sectionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_switch_search_condition_section;
	}
	public enterRule(listener: SqlListener): void {
...
export class As_column_aliasContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_as_column_alias;
	}
	public enterRule(listener: SqlListener): void {
...
export class As_table_aliasContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_as_table_alias;
	}
	public enterRule(listener: SqlListener): void {
...
export class With_table_hintsContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_with_table_hints;
	}
	public enterRule(listener: SqlListener): void {
...
export class Insert_with_table_hintsContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_insert_with_table_hints;
	}
	public enterRule(listener: SqlListener): void {
...
export class Table_hintContext extends ParserRuleContext {
	...
	public FORCESEEK(): TerminalNode {
		return this.getToken(SqlParser.FORCESEEK, 0);
	}
	...
	public SPATIAL_WINDOW_MAX_CELLS(): TerminalNode {
		return this.getToken(SqlParser.SPATIAL_WINDOW_MAX_CELLS, 0);
	}
	public DECIMAL(): TerminalNode {
		return this.getToken(SqlParser.DECIMAL, 0);
	}
	...
	public NOEXPAND(): TerminalNode {
		return this.getToken(SqlParser.NOEXPAND, 0);
	}
	public LR_BRACKET_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.LR_BRACKET);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_table_hint;
	}
	public enterRule(listener: SqlListener): void {
...
export class Index_valueContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_index_value;
	}
	public enterRule(listener: SqlListener): void {
...
export class Column_alias_listContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_column_alias_list;
	}
	public enterRule(listener: SqlListener): void {
...
export class Table_value_constructorContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_table_value_constructor;
	}
	public enterRule(listener: SqlListener): void {
...
export class Ranking_windowed_functionContext extends ParserRuleContext {
	...
	public RANK(): TerminalNode {
		return this.getToken(SqlParser.RANK, 0);
	}
	public DENSE_RANK(): TerminalNode {
		return this.getToken(SqlParser.DENSE_RANK, 0);
	}
	public ROW_NUMBER(): TerminalNode {
		return this.getToken(SqlParser.ROW_NUMBER, 0);
	}
	public NTILE(): TerminalNode {
		return this.getToken(SqlParser.NTILE, 0);
	}
	public expression(): ExpressionContext {
		return this.getTypedRuleContext(ExpressionContext, 0) as ExpressionContext;
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_ranking_windowed_function;
	}
	public enterRule(listener: SqlListener): void {
...
export class Aggregate_windowed_functionContext extends ParserRuleContext {
	...
	public STDEV(): TerminalNode {
		return this.getToken(SqlParser.STDEV, 0);
	}
	public STDEVP(): TerminalNode {
		return this.getToken(SqlParser.STDEVP, 0);
	}
	public VAR(): TerminalNode {
		return this.getToken(SqlParser.VAR, 0);
	}
	public VARP(): TerminalNode {
		return this.getToken(SqlParser.VARP, 0);
	}
	public over_clause(): Over_clauseContext {
		return this.getTypedRuleContext(Over_clauseContext, 0) as Over_clauseContext;
	}
	...
	public COUNT_BIG(): TerminalNode {
		return this.getToken(SqlParser.COUNT_BIG, 0);
	}
	public STAR(): TerminalNode {
		return this.getToken(SqlParser.STAR, 0);
	}
	public CHECKSUM_AGG(): TerminalNode {
		return this.getToken(SqlParser.CHECKSUM_AGG, 0);
	}
	...
	public GROUPING_ID(): TerminalNode {
		return this.getToken(SqlParser.GROUPING_ID, 0);
	}
	public expression_list(): Expression_listContext {
		return this.getTypedRuleContext(Expression_listContext, 0) as Expression_listContext;
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_aggregate_windowed_function;
	}
	public enterRule(listener: SqlListener): void {
...
export class Analytic_windowed_functionContext extends ParserRuleContext {
	...
	public FIRST_VALUE(): TerminalNode {
		return this.getToken(SqlParser.FIRST_VALUE, 0);
	}
	public LAST_VALUE(): TerminalNode {
		return this.getToken(SqlParser.LAST_VALUE, 0);
	}
	public LAG(): TerminalNode {
		return this.getToken(SqlParser.LAG, 0);
	}
	public LEAD(): TerminalNode {
		return this.getToken(SqlParser.LEAD, 0);
	}
	public COMMA_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.COMMA);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_analytic_windowed_function;
	}
	public enterRule(listener: SqlListener): void {
...
export class All_distinct_expressionContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_all_distinct_expression;
	}
	public enterRule(listener: SqlListener): void {
...
export class Row_or_range_clauseContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_row_or_range_clause;
	}
	public enterRule(listener: SqlListener): void {
...
export class Window_frame_extentContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_window_frame_extent;
	}
	public enterRule(listener: SqlListener): void {
...
export class Window_frame_boundContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_window_frame_bound;
	}
	public enterRule(listener: SqlListener): void {
...
export class Window_frame_precedingContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_window_frame_preceding;
	}
	public enterRule(listener: SqlListener): void {
...
export class Window_frame_followingContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_window_frame_following;
	}
	public enterRule(listener: SqlListener): void {
...
export class Full_table_nameContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_full_table_name;
	}
	public enterRule(listener: SqlListener): void {
...
export class Simple_nameContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_simple_name;
	}
	public enterRule(listener: SqlListener): void {
...
export class Func_proc_name_schemaContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_func_proc_name_schema;
	}
	public enterRule(listener: SqlListener): void {
...
export class Func_proc_name_database_schemaContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_func_proc_name_database_schema;
	}
	public enterRule(listener: SqlListener): void {
...
export class Func_proc_name_server_database_schemaContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_func_proc_name_server_database_schema;
	}
	public enterRule(listener: SqlListener): void {
...
export class Ddl_objectContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_ddl_object;
	}
	public enterRule(listener: SqlListener): void {
...
export class Full_column_nameContext extends ParserRuleContext {
	...
	public COMPATIBILITY_LEVEL(): TerminalNode {
		return this.getToken(SqlParser.COMPATIBILITY_LEVEL, 0);
	}
	...
	public ARITHABORT(): TerminalNode {
		return this.getToken(SqlParser.ARITHABORT, 0);
	}
	public ANSI_WARNINGS(): TerminalNode {
		return this.getToken(SqlParser.ANSI_WARNINGS, 0);
	}
	public ANSI_PADDING(): TerminalNode {
		return this.getToken(SqlParser.ANSI_PADDING, 0);
	}
	public ANSI_NULLS(): TerminalNode {
		return this.getToken(SqlParser.ANSI_NULLS, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_full_column_name;
	}
	public enterRule(listener: SqlListener): void {
...
export class Column_name_list_with_orderContext extends ParserRuleContext {
	...
	public ASC_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.ASC);
	}
	public ASC(i: number): TerminalNode {
		return this.getToken(SqlParser.ASC, i);
	}
	public DESC_list(): TerminalNode[] {
	    	return this.getTokens(SqlParser.DESC);
	}
	public DESC(i: number): TerminalNode {
		return this.getToken(SqlParser.DESC, i);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_column_name_list_with_order;
	}
	public enterRule(listener: SqlListener): void {
...
export class On_offContext extends ParserRuleContext {
	...
	public OFF(): TerminalNode {
		return this.getToken(SqlParser.OFF, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_on_off;
	}
	public enterRule(listener: SqlListener): void {
...
export class ClusteredContext extends ParserRuleContext {
	...
	public NONCLUSTERED(): TerminalNode {
		return this.getToken(SqlParser.NONCLUSTERED, 0);
	}
    public get ruleIndex(): number {
...
export class Null_notnullContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_null_notnull;
	}
	public enterRule(listener: SqlListener): void {
...
export class Null_or_defaultContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_null_or_default;
	}
	public enterRule(listener: SqlListener): void {
...
export class Scalar_function_nameContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_scalar_function_name;
	}
	public enterRule(listener: SqlListener): void {
...
export class IdContext extends ParserRuleContext {
	...
	public SQUARE_BRACKET_ID(): TerminalNode {
		return this.getToken(SqlParser.SQUARE_BRACKET_ID, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_id;
	}
	public enterRule(listener: SqlListener): void {
	    if(listener.enterId) {
...
export class Simple_idContext extends ParserRuleContext {
	...
	public ABSOLUTE(): TerminalNode {
		return this.getToken(SqlParser.ABSOLUTE, 0);
	}
	public ACCENT_SENSITIVITY(): TerminalNode {
		return this.getToken(SqlParser.ACCENT_SENSITIVITY, 0);
	}
	public ACTION(): TerminalNode {
		return this.getToken(SqlParser.ACTION, 0);
	}
	public ACTIVATION(): TerminalNode {
		return this.getToken(SqlParser.ACTIVATION, 0);
	}
	public ACTIVE(): TerminalNode {
		return this.getToken(SqlParser.ACTIVE, 0);
	}
	public ADDRESS(): TerminalNode {
		return this.getToken(SqlParser.ADDRESS, 0);
	}
	public AES_128(): TerminalNode {
		return this.getToken(SqlParser.AES_128, 0);
	}
	public AES_192(): TerminalNode {
		return this.getToken(SqlParser.AES_192, 0);
	}
	public AES_256(): TerminalNode {
		return this.getToken(SqlParser.AES_256, 0);
	}
	public AFFINITY(): TerminalNode {
		return this.getToken(SqlParser.AFFINITY, 0);
	}
	...
	public ALLOW_ENCRYPTED_VALUE_MODIFICATIONS(): TerminalNode {
		return this.getToken(SqlParser.ALLOW_ENCRYPTED_VALUE_MODIFICATIONS, 0);
	}
	public ALLOW_SNAPSHOT_ISOLATION(): TerminalNode {
		return this.getToken(SqlParser.ALLOW_SNAPSHOT_ISOLATION, 0);
	}
	public ALLOWED(): TerminalNode {
		return this.getToken(SqlParser.ALLOWED, 0);
	}
	public ANSI_NULL_DEFAULT(): TerminalNode {
		return this.getToken(SqlParser.ANSI_NULL_DEFAULT, 0);
	}
	public ANSI_NULLS(): TerminalNode {
		return this.getToken(SqlParser.ANSI_NULLS, 0);
	}
	...
	public APPLICATION_LOG(): TerminalNode {
		return this.getToken(SqlParser.APPLICATION_LOG, 0);
	}
	public APPLY(): TerminalNode {
		return this.getToken(SqlParser.APPLY, 0);
	}
	...
	public ASSEMBLY(): TerminalNode {
		return this.getToken(SqlParser.ASSEMBLY, 0);
	}
	public AUDIT(): TerminalNode {
		return this.getToken(SqlParser.AUDIT, 0);
	}
	public AUDIT_GUID(): TerminalNode {
		return this.getToken(SqlParser.AUDIT_GUID, 0);
	}
	public AUTO(): TerminalNode {
		return this.getToken(SqlParser.AUTO, 0);
	}
	public AUTO_CLEANUP(): TerminalNode {
		return this.getToken(SqlParser.AUTO_CLEANUP, 0);
	}
	public AUTO_CLOSE(): TerminalNode {
		return this.getToken(SqlParser.AUTO_CLOSE, 0);
	}
	public AUTO_CREATE_STATISTICS(): TerminalNode {
		return this.getToken(SqlParser.AUTO_CREATE_STATISTICS, 0);
	}
	public AUTO_SHRINK(): TerminalNode {
		return this.getToken(SqlParser.AUTO_SHRINK, 0);
	}
	public AUTO_UPDATE_STATISTICS(): TerminalNode {
		return this.getToken(SqlParser.AUTO_UPDATE_STATISTICS, 0);
	}
	public AUTO_UPDATE_STATISTICS_ASYNC(): TerminalNode {
		return this.getToken(SqlParser.AUTO_UPDATE_STATISTICS_ASYNC, 0);
	}
	public AVAILABILITY(): TerminalNode {
		return this.getToken(SqlParser.AVAILABILITY, 0);
	}
	public AVG(): TerminalNode {
		return this.getToken(SqlParser.AVG, 0);
	}
	public BACKUP_PRIORITY(): TerminalNode {
		return this.getToken(SqlParser.BACKUP_PRIORITY, 0);
	}
	public BEGIN_DIALOG(): TerminalNode {
		return this.getToken(SqlParser.BEGIN_DIALOG, 0);
	}
	public BIGINT(): TerminalNode {
		return this.getToken(SqlParser.BIGINT, 0);
	}
	...
	public BINDING(): TerminalNode {
		return this.getToken(SqlParser.BINDING, 0);
	}
	public BLOB_STORAGE(): TerminalNode {
		return this.getToken(SqlParser.BLOB_STORAGE, 0);
	}
	public BROKER(): TerminalNode {
		return this.getToken(SqlParser.BROKER, 0);
	}
	public BROKER_INSTANCE(): TerminalNode {
		return this.getToken(SqlParser.BROKER_INSTANCE, 0);
	}
	public BULK_LOGGED(): TerminalNode {
		return this.getToken(SqlParser.BULK_LOGGED, 0);
	}
	public CALLED(): TerminalNode {
		return this.getToken(SqlParser.CALLED, 0);
	}
	public CALLER(): TerminalNode {
		return this.getToken(SqlParser.CALLER, 0);
	}
	public CAP_CPU_PERCENT(): TerminalNode {
		return this.getToken(SqlParser.CAP_CPU_PERCENT, 0);
	}
	public CAST(): TerminalNode {
		return this.getToken(SqlParser.CAST, 0);
	}
	public CATALOG(): TerminalNode {
		return this.getToken(SqlParser.CATALOG, 0);
	}
	public CATCH(): TerminalNode {
		return this.getToken(SqlParser.CATCH, 0);
	}
	public CHANGE_RETENTION(): TerminalNode {
		return this.getToken(SqlParser.CHANGE_RETENTION, 0);
	}
	public CHANGE_TRACKING(): TerminalNode {
		return this.getToken(SqlParser.CHANGE_TRACKING, 0);
	}
	public CHECKSUM(): TerminalNode {
		return this.getToken(SqlParser.CHECKSUM, 0);
	}
	...
	public CONCAT_NULL_YIELDS_NULL(): TerminalNode {
		return this.getToken(SqlParser.CONCAT_NULL_YIELDS_NULL, 0);
	}
	public CONTENT(): TerminalNode {
		return this.getToken(SqlParser.CONTENT, 0);
	}
	public CONTROL(): TerminalNode {
		return this.getToken(SqlParser.CONTROL, 0);
	}
	public COOKIE(): TerminalNode {
		return this.getToken(SqlParser.COOKIE, 0);
	}
	public COUNT(): TerminalNode {
		return this.getToken(SqlParser.COUNT, 0);
	}
	...
	public COUNTER(): TerminalNode {
		return this.getToken(SqlParser.COUNTER, 0);
	}
	public CPU(): TerminalNode {
		return this.getToken(SqlParser.CPU, 0);
	}
	public CREATE_NEW(): TerminalNode {
		return this.getToken(SqlParser.CREATE_NEW, 0);
	}
	public CREATION_DISPOSITION(): TerminalNode {
		return this.getToken(SqlParser.CREATION_DISPOSITION, 0);
	}
	public CREDENTIAL(): TerminalNode {
		return this.getToken(SqlParser.CREDENTIAL, 0);
	}
	public CRYPTOGRAPHIC(): TerminalNode {
		return this.getToken(SqlParser.CRYPTOGRAPHIC, 0);
	}
	public CURSOR_CLOSE_ON_COMMIT(): TerminalNode {
		return this.getToken(SqlParser.CURSOR_CLOSE_ON_COMMIT, 0);
	}
	public CURSOR_DEFAULT(): TerminalNode {
		return this.getToken(SqlParser.CURSOR_DEFAULT, 0);
	}
	public DATA(): TerminalNode {
		return this.getToken(SqlParser.DATA, 0);
	}
	public DATA_COMPRESSION(): TerminalNode {
		return this.getToken(SqlParser.DATA_COMPRESSION, 0);
	}
	public DATE_CORRELATION_OPTIMIZATION(): TerminalNode {
		return this.getToken(SqlParser.DATE_CORRELATION_OPTIMIZATION, 0);
	}
	public DATEADD(): TerminalNode {
		return this.getToken(SqlParser.DATEADD, 0);
	}
	...
	public DAYS(): TerminalNode {
		return this.getToken(SqlParser.DAYS, 0);
	}
	public DB_CHAINING(): TerminalNode {
		return this.getToken(SqlParser.DB_CHAINING, 0);
	}
	public DB_FAILOVER(): TerminalNode {
		return this.getToken(SqlParser.DB_FAILOVER, 0);
	}
	public DECRYPTION(): TerminalNode {
		return this.getToken(SqlParser.DECRYPTION, 0);
	}
	public DEFAULT_DOUBLE_QUOTE(): TerminalNode {
		return this.getToken(SqlParser.DEFAULT_DOUBLE_QUOTE, 0);
	}
	public DEFAULT_FULLTEXT_LANGUAGE(): TerminalNode {
		return this.getToken(SqlParser.DEFAULT_FULLTEXT_LANGUAGE, 0);
	}
	public DEFAULT_LANGUAGE(): TerminalNode {
		return this.getToken(SqlParser.DEFAULT_LANGUAGE, 0);
	}
	public DELAY(): TerminalNode {
		return this.getToken(SqlParser.DELAY, 0);
	}
	public DELAYED_DURABILITY(): TerminalNode {
		return this.getToken(SqlParser.DELAYED_DURABILITY, 0);
	}
	public DELETED(): TerminalNode {
		return this.getToken(SqlParser.DELETED, 0);
	}
	...
	public DEPENDENTS(): TerminalNode {
		return this.getToken(SqlParser.DEPENDENTS, 0);
	}
	public DES(): TerminalNode {
		return this.getToken(SqlParser.DES, 0);
	}
	public DESCRIPTION(): TerminalNode {
		return this.getToken(SqlParser.DESCRIPTION, 0);
	}
	public DESX(): TerminalNode {
		return this.getToken(SqlParser.DESX, 0);
	}
	public DHCP(): TerminalNode {
		return this.getToken(SqlParser.DHCP, 0);
	}
	public DIALOG(): TerminalNode {
		return this.getToken(SqlParser.DIALOG, 0);
	}
	public DIRECTORY_NAME(): TerminalNode {
		return this.getToken(SqlParser.DIRECTORY_NAME, 0);
	}
	public DISABLE(): TerminalNode {
		return this.getToken(SqlParser.DISABLE, 0);
	}
	public DISABLE_BROKER(): TerminalNode {
		return this.getToken(SqlParser.DISABLE_BROKER, 0);
	}
	public DISABLED(): TerminalNode {
		return this.getToken(SqlParser.DISABLED, 0);
	}
	public DISK_DRIVE(): TerminalNode {
		return this.getToken(SqlParser.DISK_DRIVE, 0);
	}
	public DOCUMENT(): TerminalNode {
		return this.getToken(SqlParser.DOCUMENT, 0);
	}
	public DYNAMIC(): TerminalNode {
		return this.getToken(SqlParser.DYNAMIC, 0);
	}
	public EMERGENCY(): TerminalNode {
		return this.getToken(SqlParser.EMERGENCY, 0);
	}
	public EMPTY(): TerminalNode {
		return this.getToken(SqlParser.EMPTY, 0);
	}
	public ENABLE(): TerminalNode {
		return this.getToken(SqlParser.ENABLE, 0);
	}
	public ENABLE_BROKER(): TerminalNode {
		return this.getToken(SqlParser.ENABLE_BROKER, 0);
	}
	public ENCRYPTED_VALUE(): TerminalNode {
		return this.getToken(SqlParser.ENCRYPTED_VALUE, 0);
	}
	public ENCRYPTION(): TerminalNode {
		return this.getToken(SqlParser.ENCRYPTION, 0);
	}
	public ENDPOINT_URL(): TerminalNode {
		return this.getToken(SqlParser.ENDPOINT_URL, 0);
	}
	public ERROR_BROKER_CONVERSATIONS(): TerminalNode {
		return this.getToken(SqlParser.ERROR_BROKER_CONVERSATIONS, 0);
	}
	public EVENTDATA(): TerminalNode {
		return this.getToken(SqlParser.EVENTDATA, 0);
	}
	...
	public EXECUTABLE(): TerminalNode {
		return this.getToken(SqlParser.EXECUTABLE, 0);
	}
	public EXIST(): TerminalNode {
		return this.getToken(SqlParser.EXIST, 0);
	}
	...
	public EXPIREDATE(): TerminalNode {
		return this.getToken(SqlParser.EXPIREDATE, 0);
	}
	public EXPIRY_DATE(): TerminalNode {
		return this.getToken(SqlParser.EXPIRY_DATE, 0);
	}
	public EXPLICIT(): TerminalNode {
		return this.getToken(SqlParser.EXPLICIT, 0);
	}
	public FAIL_OPERATION(): TerminalNode {
		return this.getToken(SqlParser.FAIL_OPERATION, 0);
	}
	public FAILOVER_MODE(): TerminalNode {
		return this.getToken(SqlParser.FAILOVER_MODE, 0);
	}
	public FAILURE(): TerminalNode {
		return this.getToken(SqlParser.FAILURE, 0);
	}
	public FAILURE_CONDITION_LEVEL(): TerminalNode {
		return this.getToken(SqlParser.FAILURE_CONDITION_LEVEL, 0);
	}
	public FAST(): TerminalNode {
		return this.getToken(SqlParser.FAST, 0);
	}
	public FAST_FORWARD(): TerminalNode {
		return this.getToken(SqlParser.FAST_FORWARD, 0);
	}
	public FILEGROUP(): TerminalNode {
		return this.getToken(SqlParser.FILEGROUP, 0);
	}
	public FILEGROWTH(): TerminalNode {
		return this.getToken(SqlParser.FILEGROWTH, 0);
	}
	public FILENAME(): TerminalNode {
		return this.getToken(SqlParser.FILENAME, 0);
	}
	public FILEPATH(): TerminalNode {
		return this.getToken(SqlParser.FILEPATH, 0);
	}
	public FILESTREAM(): TerminalNode {
		return this.getToken(SqlParser.FILESTREAM, 0);
	}
	public FILLFACTOR(): TerminalNode {
		return this.getToken(SqlParser.FILLFACTOR, 0);
	}
	...
	public FORCE_FAILOVER_ALLOW_DATA_LOSS(): TerminalNode {
		return this.getToken(SqlParser.FORCE_FAILOVER_ALLOW_DATA_LOSS, 0);
	}
	public FORCED(): TerminalNode {
		return this.getToken(SqlParser.FORCED, 0);
	}
	...
	public FORWARD_ONLY(): TerminalNode {
		return this.getToken(SqlParser.FORWARD_ONLY, 0);
	}
	public FULLSCAN(): TerminalNode {
		return this.getToken(SqlParser.FULLSCAN, 0);
	}
	public FULLTEXT(): TerminalNode {
		return this.getToken(SqlParser.FULLTEXT, 0);
	}
	public GB(): TerminalNode {
		return this.getToken(SqlParser.GB, 0);
	}
	public GETDATE(): TerminalNode {
		return this.getToken(SqlParser.GETDATE, 0);
	}
	...
	public GO(): TerminalNode {
		return this.getToken(SqlParser.GO, 0);
	}
	public GROUP_MAX_REQUESTS(): TerminalNode {
		return this.getToken(SqlParser.GROUP_MAX_REQUESTS, 0);
	}
	public GROUPING(): TerminalNode {
		return this.getToken(SqlParser.GROUPING, 0);
	}
	...
	public HADR(): TerminalNode {
		return this.getToken(SqlParser.HADR, 0);
	}
	public HASH(): TerminalNode {
		return this.getToken(SqlParser.HASH, 0);
	}
	public HEALTH_CHECK_TIMEOUT(): TerminalNode {
		return this.getToken(SqlParser.HEALTH_CHECK_TIMEOUT, 0);
	}
	public HIGH(): TerminalNode {
		return this.getToken(SqlParser.HIGH, 0);
	}
	public HONOR_BROKER_PRIORITY(): TerminalNode {
		return this.getToken(SqlParser.HONOR_BROKER_PRIORITY, 0);
	}
	public HOURS(): TerminalNode {
		return this.getToken(SqlParser.HOURS, 0);
	}
	public IDENTITY_VALUE(): TerminalNode {
		return this.getToken(SqlParser.IDENTITY_VALUE, 0);
	}
	public IGNORE_NONCLUSTERED_COLUMNSTORE_INDEX(): TerminalNode {
		return this.getToken(SqlParser.IGNORE_NONCLUSTERED_COLUMNSTORE_INDEX, 0);
	}
	public IMMEDIATE(): TerminalNode {
		return this.getToken(SqlParser.IMMEDIATE, 0);
	}
	public IMPERSONATE(): TerminalNode {
		return this.getToken(SqlParser.IMPERSONATE, 0);
	}
	public IMPORTANCE(): TerminalNode {
		return this.getToken(SqlParser.IMPORTANCE, 0);
	}
	public INCREMENTAL(): TerminalNode {
		return this.getToken(SqlParser.INCREMENTAL, 0);
	}
	public INIT(): TerminalNode {
		return this.getToken(SqlParser.INIT, 0);
	}
	public INITIATOR(): TerminalNode {
		return this.getToken(SqlParser.INITIATOR, 0);
	}
	public INPUT(): TerminalNode {
		return this.getToken(SqlParser.INPUT, 0);
	}
	public INSENSITIVE(): TerminalNode {
		return this.getToken(SqlParser.INSENSITIVE, 0);
	}
	public INSERTED(): TerminalNode {
		return this.getToken(SqlParser.INSERTED, 0);
	}
	...
	public LISTENER(): TerminalNode {
		return this.getToken(SqlParser.LISTENER, 0);
	}
	public LISTENER_URL(): TerminalNode {
		return this.getToken(SqlParser.LISTENER_URL, 0);
	}
	public LOB_COMPACTION(): TerminalNode {
		return this.getToken(SqlParser.LOB_COMPACTION, 0);
	}
	...
	public LOW(): TerminalNode {
		return this.getToken(SqlParser.LOW, 0);
	}
	public MANUAL(): TerminalNode {
		return this.getToken(SqlParser.MANUAL, 0);
	}
	public MARK(): TerminalNode {
		return this.getToken(SqlParser.MARK, 0);
	}
	...
	public MAX_CPU_PERCENT(): TerminalNode {
		return this.getToken(SqlParser.MAX_CPU_PERCENT, 0);
	}
	public MAX_DOP(): TerminalNode {
		return this.getToken(SqlParser.MAX_DOP, 0);
	}
	public MAX_FILES(): TerminalNode {
		return this.getToken(SqlParser.MAX_FILES, 0);
	}
	public MAX_IOPS_PER_VOLUME(): TerminalNode {
		return this.getToken(SqlParser.MAX_IOPS_PER_VOLUME, 0);
	}
	public MAX_MEMORY(): TerminalNode {
		return this.getToken(SqlParser.MAX_MEMORY, 0);
	}
	public MAX_MEMORY_PERCENT(): TerminalNode {
		return this.getToken(SqlParser.MAX_MEMORY_PERCENT, 0);
	}
	public MAX_PROCESSES(): TerminalNode {
		return this.getToken(SqlParser.MAX_PROCESSES, 0);
	}
	public MAX_QUEUE_READERS(): TerminalNode {
		return this.getToken(SqlParser.MAX_QUEUE_READERS, 0);
	}
	public MAX_ROLLOVER_FILES(): TerminalNode {
		return this.getToken(SqlParser.MAX_ROLLOVER_FILES, 0);
	}
	public MAXDOP(): TerminalNode {
		return this.getToken(SqlParser.MAXDOP, 0);
	}
	...
	public MAXSIZE(): TerminalNode {
		return this.getToken(SqlParser.MAXSIZE, 0);
	}
	public MB(): TerminalNode {
		return this.getToken(SqlParser.MB, 0);
	}
	public MEDIUM(): TerminalNode {
		return this.getToken(SqlParser.MEDIUM, 0);
	}
	public MEMORY_OPTIMIZED_DATA(): TerminalNode {
		return this.getToken(SqlParser.MEMORY_OPTIMIZED_DATA, 0);
	}
	public MESSAGE(): TerminalNode {
		return this.getToken(SqlParser.MESSAGE, 0);
	}
	public MIN(): TerminalNode {
		return this.getToken(SqlParser.MIN, 0);
	}
	...
	public MIN_CPU_PERCENT(): TerminalNode {
		return this.getToken(SqlParser.MIN_CPU_PERCENT, 0);
	}
	public MIN_IOPS_PER_VOLUME(): TerminalNode {
		return this.getToken(SqlParser.MIN_IOPS_PER_VOLUME, 0);
	}
	public MIN_MEMORY_PERCENT(): TerminalNode {
		return this.getToken(SqlParser.MIN_MEMORY_PERCENT, 0);
	}
	public MINUTES(): TerminalNode {
		return this.getToken(SqlParser.MINUTES, 0);
	}
	public MIRROR_ADDRESS(): TerminalNode {
		return this.getToken(SqlParser.MIRROR_ADDRESS, 0);
	}
	public MIXED_PAGE_ALLOCATION(): TerminalNode {
		return this.getToken(SqlParser.MIXED_PAGE_ALLOCATION, 0);
	}
	...
	public MOVE(): TerminalNode {
		return this.getToken(SqlParser.MOVE, 0);
	}
	public MULTI_USER(): TerminalNode {
		return this.getToken(SqlParser.MULTI_USER, 0);
	}
	public NAME(): TerminalNode {
		return this.getToken(SqlParser.NAME, 0);
	}
	public NESTED_TRIGGERS(): TerminalNode {
		return this.getToken(SqlParser.NESTED_TRIGGERS, 0);
	}
	public NEW_ACCOUNT(): TerminalNode {
		return this.getToken(SqlParser.NEW_ACCOUNT, 0);
	}
	public NEW_BROKER(): TerminalNode {
		return this.getToken(SqlParser.NEW_BROKER, 0);
	}
	public NEW_PASSWORD(): TerminalNode {
		return this.getToken(SqlParser.NEW_PASSWORD, 0);
	}
	public NEXT(): TerminalNode {
		return this.getToken(SqlParser.NEXT, 0);
	}
	...
	public NO_TRUNCATE(): TerminalNode {
		return this.getToken(SqlParser.NO_TRUNCATE, 0);
	}
	public NO_WAIT(): TerminalNode {
		return this.getToken(SqlParser.NO_WAIT, 0);
	}
	public NOCOUNT(): TerminalNode {
		return this.getToken(SqlParser.NOCOUNT, 0);
	}
	public NODES(): TerminalNode {
		return this.getToken(SqlParser.NODES, 0);
	}
	...
	public NON_TRANSACTED_ACCESS(): TerminalNode {
		return this.getToken(SqlParser.NON_TRANSACTED_ACCESS, 0);
	}
	public NORECOMPUTE(): TerminalNode {
		return this.getToken(SqlParser.NORECOMPUTE, 0);
	}
	public NORECOVERY(): TerminalNode {
		return this.getToken(SqlParser.NORECOVERY, 0);
	}
	public NOWAIT(): TerminalNode {
		return this.getToken(SqlParser.NOWAIT, 0);
	}
	public NTILE(): TerminalNode {
		return this.getToken(SqlParser.NTILE, 0);
	}
	public NUMANODE(): TerminalNode {
		return this.getToken(SqlParser.NUMANODE, 0);
	}
	public NUMBER(): TerminalNode {
		return this.getToken(SqlParser.NUMBER, 0);
	}
	public NUMERIC_ROUNDABORT(): TerminalNode {
		return this.getToken(SqlParser.NUMERIC_ROUNDABORT, 0);
	}
	public OBJECT(): TerminalNode {
		return this.getToken(SqlParser.OBJECT, 0);
	}
	...
	public OFFSETS(): TerminalNode {
		return this.getToken(SqlParser.OFFSETS, 0);
	}
	public OLD_ACCOUNT(): TerminalNode {
		return this.getToken(SqlParser.OLD_ACCOUNT, 0);
	}
	...
	public OPEN_EXISTING(): TerminalNode {
		return this.getToken(SqlParser.OPEN_EXISTING, 0);
	}
	public OPTIMISTIC(): TerminalNode {
		return this.getToken(SqlParser.OPTIMISTIC, 0);
	}
	public OPTIMIZE(): TerminalNode {
		return this.getToken(SqlParser.OPTIMIZE, 0);
	}
	...
	public PAGE_VERIFY(): TerminalNode {
		return this.getToken(SqlParser.PAGE_VERIFY, 0);
	}
	public PARAMETERIZATION(): TerminalNode {
		return this.getToken(SqlParser.PARAMETERIZATION, 0);
	}
	...
	public PARTNER(): TerminalNode {
		return this.getToken(SqlParser.PARTNER, 0);
	}
	public PATH(): TerminalNode {
		return this.getToken(SqlParser.PATH, 0);
	}
	public POISON_MESSAGE_HANDLING(): TerminalNode {
		return this.getToken(SqlParser.POISON_MESSAGE_HANDLING, 0);
	}
	public POLICY(): TerminalNode {
		return this.getToken(SqlParser.POLICY, 0);
	}
	public POOL(): TerminalNode {
		return this.getToken(SqlParser.POOL, 0);
	}
	...
	public PRIMARY_ROLE(): TerminalNode {
		return this.getToken(SqlParser.PRIMARY_ROLE, 0);
	}
	public PRIOR(): TerminalNode {
		return this.getToken(SqlParser.PRIOR, 0);
	}
	public PRIORITY(): TerminalNode {
		return this.getToken(SqlParser.PRIORITY, 0);
	}
	public PRIORITY_LEVEL(): TerminalNode {
		return this.getToken(SqlParser.PRIORITY_LEVEL, 0);
	}
	public PRIVATE(): TerminalNode {
		return this.getToken(SqlParser.PRIVATE, 0);
	}
	public PRIVATE_KEY(): TerminalNode {
		return this.getToken(SqlParser.PRIVATE_KEY, 0);
	}
	public PRIVILEGES(): TerminalNode {
		return this.getToken(SqlParser.PRIVILEGES, 0);
	}
	public PROCEDURE_NAME(): TerminalNode {
		return this.getToken(SqlParser.PROCEDURE_NAME, 0);
	}
	public PROPERTY(): TerminalNode {
		return this.getToken(SqlParser.PROPERTY, 0);
	}
	public PROVIDER(): TerminalNode {
		return this.getToken(SqlParser.PROVIDER, 0);
	}
	public PROVIDER_KEY_NAME(): TerminalNode {
		return this.getToken(SqlParser.PROVIDER_KEY_NAME, 0);
	}
	...
	public QUEUE(): TerminalNode {
		return this.getToken(SqlParser.QUEUE, 0);
	}
	public QUEUE_DELAY(): TerminalNode {
		return this.getToken(SqlParser.QUEUE_DELAY, 0);
	}
	public QUOTED_IDENTIFIER(): TerminalNode {
		return this.getToken(SqlParser.QUOTED_IDENTIFIER, 0);
	}
	public R(): TerminalNode {
		return this.getToken(SqlParser.R, 0);
	}
	public RANGE(): TerminalNode {
		return this.getToken(SqlParser.RANGE, 0);
	}
	...
	public RC2(): TerminalNode {
		return this.getToken(SqlParser.RC2, 0);
	}
	public RC4(): TerminalNode {
		return this.getToken(SqlParser.RC4, 0);
	}
	public RC4_128(): TerminalNode {
		return this.getToken(SqlParser.RC4_128, 0);
	}
	public READ_COMMITTED_SNAPSHOT(): TerminalNode {
		return this.getToken(SqlParser.READ_COMMITTED_SNAPSHOT, 0);
	}
	public READ_ONLY(): TerminalNode {
		return this.getToken(SqlParser.READ_ONLY, 0);
	}
	public READ_ONLY_ROUTING_LIST(): TerminalNode {
		return this.getToken(SqlParser.READ_ONLY_ROUTING_LIST, 0);
	}
	public READ_WRITE(): TerminalNode {
		return this.getToken(SqlParser.READ_WRITE, 0);
	}
	public READONLY(): TerminalNode {
		return this.getToken(SqlParser.READONLY, 0);
	}
	public REBUILD(): TerminalNode {
		return this.getToken(SqlParser.REBUILD, 0);
	}
	public RECEIVE(): TerminalNode {
		return this.getToken(SqlParser.RECEIVE, 0);
	}
	public RECOMPILE(): TerminalNode {
		return this.getToken(SqlParser.RECOMPILE, 0);
	}
	public RECOVERY(): TerminalNode {
		return this.getToken(SqlParser.RECOVERY, 0);
	}
	public RECURSIVE_TRIGGERS(): TerminalNode {
		return this.getToken(SqlParser.RECURSIVE_TRIGGERS, 0);
	}
	public RELATIVE(): TerminalNode {
		return this.getToken(SqlParser.RELATIVE, 0);
	}
	public REMOTE(): TerminalNode {
		return this.getToken(SqlParser.REMOTE, 0);
	}
	public REMOTE_SERVICE_NAME(): TerminalNode {
		return this.getToken(SqlParser.REMOTE_SERVICE_NAME, 0);
	}
	...
	public REPLICA(): TerminalNode {
		return this.getToken(SqlParser.REPLICA, 0);
	}
	public REQUEST_MAX_CPU_TIME_SEC(): TerminalNode {
		return this.getToken(SqlParser.REQUEST_MAX_CPU_TIME_SEC, 0);
	}
	public REQUEST_MAX_MEMORY_GRANT_PERCENT(): TerminalNode {
		return this.getToken(SqlParser.REQUEST_MAX_MEMORY_GRANT_PERCENT, 0);
	}
	public REQUEST_MEMORY_GRANT_TIMEOUT_SEC(): TerminalNode {
		return this.getToken(SqlParser.REQUEST_MEMORY_GRANT_TIMEOUT_SEC, 0);
	}
	public REQUIRED_SYNCHRONIZED_SECONDARIES_TO_COMMIT(): TerminalNode {
		return this.getToken(SqlParser.REQUIRED_SYNCHRONIZED_SECONDARIES_TO_COMMIT, 0);
	}
	public RESERVE_DISK_SPACE(): TerminalNode {
		return this.getToken(SqlParser.RESERVE_DISK_SPACE, 0);
	}
	public RESOURCE(): TerminalNode {
		return this.getToken(SqlParser.RESOURCE, 0);
	}
	public RESOURCE_MANAGER_LOCATION(): TerminalNode {
		return this.getToken(SqlParser.RESOURCE_MANAGER_LOCATION, 0);
	}
	public RESTRICTED_USER(): TerminalNode {
		return this.getToken(SqlParser.RESTRICTED_USER, 0);
	}
	public RETENTION(): TerminalNode {
		return this.getToken(SqlParser.RETENTION, 0);
	}
	...
	public ROUTE(): TerminalNode {
		return this.getToken(SqlParser.ROUTE, 0);
	}
	public ROW(): TerminalNode {
		return this.getToken(SqlParser.ROW, 0);
	}
	...
	public ROWCOUNT(): TerminalNode {
		return this.getToken(SqlParser.ROWCOUNT, 0);
	}
	public ROWGUID(): TerminalNode {
		return this.getToken(SqlParser.ROWGUID, 0);
	}
	...
	public SAFETY(): TerminalNode {
		return this.getToken(SqlParser.SAFETY, 0);
	}
	public SAMPLE(): TerminalNode {
		return this.getToken(SqlParser.SAMPLE, 0);
	}
	public SCHEMABINDING(): TerminalNode {
		return this.getToken(SqlParser.SCHEMABINDING, 0);
	}
	public SCOPED(): TerminalNode {
		return this.getToken(SqlParser.SCOPED, 0);
	}
	public SCROLL(): TerminalNode {
		return this.getToken(SqlParser.SCROLL, 0);
	}
	public SCROLL_LOCKS(): TerminalNode {
		return this.getToken(SqlParser.SCROLL_LOCKS, 0);
	}
	public SEARCH(): TerminalNode {
		return this.getToken(SqlParser.SEARCH, 0);
	}
	public SECONDARY(): TerminalNode {
		return this.getToken(SqlParser.SECONDARY, 0);
	}
	public SECONDARY_ONLY(): TerminalNode {
		return this.getToken(SqlParser.SECONDARY_ONLY, 0);
	}
	public SECONDARY_ROLE(): TerminalNode {
		return this.getToken(SqlParser.SECONDARY_ROLE, 0);
	}
	public SECONDS(): TerminalNode {
		return this.getToken(SqlParser.SECONDS, 0);
	}
	public SECRET(): TerminalNode {
		return this.getToken(SqlParser.SECRET, 0);
	}
	public SECURITY(): TerminalNode {
		return this.getToken(SqlParser.SECURITY, 0);
	}
	public SECURITY_LOG(): TerminalNode {
		return this.getToken(SqlParser.SECURITY_LOG, 0);
	}
	public SEEDING_MODE(): TerminalNode {
		return this.getToken(SqlParser.SEEDING_MODE, 0);
	}
	public SELF(): TerminalNode {
		return this.getToken(SqlParser.SELF, 0);
	}
	public SEMI_SENSITIVE(): TerminalNode {
		return this.getToken(SqlParser.SEMI_SENSITIVE, 0);
	}
	public SEND(): TerminalNode {
		return this.getToken(SqlParser.SEND, 0);
	}
	public SENT(): TerminalNode {
		return this.getToken(SqlParser.SENT, 0);
	}
	public SEQUENCE(): TerminalNode {
		return this.getToken(SqlParser.SEQUENCE, 0);
	}
	...
	public SESSION_TIMEOUT(): TerminalNode {
		return this.getToken(SqlParser.SESSION_TIMEOUT, 0);
	}
	public SETERROR(): TerminalNode {
		return this.getToken(SqlParser.SETERROR, 0);
	}
	public SHARE(): TerminalNode {
		return this.getToken(SqlParser.SHARE, 0);
	}
	public SHOWPLAN(): TerminalNode {
		return this.getToken(SqlParser.SHOWPLAN, 0);
	}
	public SID(): TerminalNode {
		return this.getToken(SqlParser.SID, 0);
	}
	public SIGNATURE(): TerminalNode {
		return this.getToken(SqlParser.SIGNATURE, 0);
	}
	public SIMPLE(): TerminalNode {
		return this.getToken(SqlParser.SIMPLE, 0);
	}
	public SINGLE_USER(): TerminalNode {
		return this.getToken(SqlParser.SINGLE_USER, 0);
	}
	public SIZE(): TerminalNode {
		return this.getToken(SqlParser.SIZE, 0);
	}
	public SMALLINT(): TerminalNode {
		return this.getToken(SqlParser.SMALLINT, 0);
	}
	...
	public SPLIT(): TerminalNode {
		return this.getToken(SqlParser.SPLIT, 0);
	}
	public STANDBY(): TerminalNode {
		return this.getToken(SqlParser.STANDBY, 0);
	}
	public START(): TerminalNode {
		return this.getToken(SqlParser.START, 0);
	}
	public START_DATE(): TerminalNode {
		return this.getToken(SqlParser.START_DATE, 0);
	}
	public STATE(): TerminalNode {
		return this.getToken(SqlParser.STATE, 0);
	}
	public STATIC(): TerminalNode {
		return this.getToken(SqlParser.STATIC, 0);
	}
	public STATS_STREAM(): TerminalNode {
		return this.getToken(SqlParser.STATS_STREAM, 0);
	}
	public STATUS(): TerminalNode {
		return this.getToken(SqlParser.STATUS, 0);
	}
	...
	public STOPLIST(): TerminalNode {
		return this.getToken(SqlParser.STOPLIST, 0);
	}
	public STRING_AGG(): TerminalNode {
		return this.getToken(SqlParser.STRING_AGG, 0);
	}
	...
	public SYNCHRONOUS_COMMIT(): TerminalNode {
		return this.getToken(SqlParser.SYNCHRONOUS_COMMIT, 0);
	}
	public SYNONYM(): TerminalNode {
		return this.getToken(SqlParser.SYNONYM, 0);
	}
	public SYSTEM(): TerminalNode {
		return this.getToken(SqlParser.SYSTEM, 0);
	}
	public TAKE(): TerminalNode {
		return this.getToken(SqlParser.TAKE, 0);
	}
	public TARGET(): TerminalNode {
		return this.getToken(SqlParser.TARGET, 0);
	}
	public TARGET_RECOVERY_TIME(): TerminalNode {
		return this.getToken(SqlParser.TARGET_RECOVERY_TIME, 0);
	}
	public TB(): TerminalNode {
		return this.getToken(SqlParser.TB, 0);
	}
	public TEXTIMAGE_ON(): TerminalNode {
		return this.getToken(SqlParser.TEXTIMAGE_ON, 0);
	}
	public THROW(): TerminalNode {
		return this.getToken(SqlParser.THROW, 0);
	}
	public TIES(): TerminalNode {
		return this.getToken(SqlParser.TIES, 0);
	}
	...
	public TIMEOUT(): TerminalNode {
		return this.getToken(SqlParser.TIMEOUT, 0);
	}
	public TIMER(): TerminalNode {
		return this.getToken(SqlParser.TIMER, 0);
	}
	public TINYINT(): TerminalNode {
		return this.getToken(SqlParser.TINYINT, 0);
	}
	public TORN_PAGE_DETECTION(): TerminalNode {
		return this.getToken(SqlParser.TORN_PAGE_DETECTION, 0);
	}
	public TRANSFORM_NOISE_WORDS(): TerminalNode {
		return this.getToken(SqlParser.TRANSFORM_NOISE_WORDS, 0);
	}
	public TRIPLE_DES(): TerminalNode {
		return this.getToken(SqlParser.TRIPLE_DES, 0);
	}
	public TRIPLE_DES_3KEY(): TerminalNode {
		return this.getToken(SqlParser.TRIPLE_DES_3KEY, 0);
	}
	public TRUSTWORTHY(): TerminalNode {
		return this.getToken(SqlParser.TRUSTWORTHY, 0);
	}
	public TRY(): TerminalNode {
		return this.getToken(SqlParser.TRY, 0);
	}
	public TSQL(): TerminalNode {
		return this.getToken(SqlParser.TSQL, 0);
	}
	public TWO_DIGIT_YEAR_CUTOFF(): TerminalNode {
		return this.getToken(SqlParser.TWO_DIGIT_YEAR_CUTOFF, 0);
	}
	public TYPE(): TerminalNode {
		return this.getToken(SqlParser.TYPE, 0);
	}
	public TYPE_WARNING(): TerminalNode {
		return this.getToken(SqlParser.TYPE_WARNING, 0);
	}
	public UNBOUNDED(): TerminalNode {
		return this.getToken(SqlParser.UNBOUNDED, 0);
	}
	...
	public UNLIMITED(): TerminalNode {
		return this.getToken(SqlParser.UNLIMITED, 0);
	}
	public URL(): TerminalNode {
		return this.getToken(SqlParser.URL, 0);
	}
	public USING(): TerminalNode {
		return this.getToken(SqlParser.USING, 0);
	}
	public VALID_XML(): TerminalNode {
		return this.getToken(SqlParser.VALID_XML, 0);
	}
	...
	public WELL_FORMED_XML(): TerminalNode {
		return this.getToken(SqlParser.WELL_FORMED_XML, 0);
	}
	public WORK(): TerminalNode {
		return this.getToken(SqlParser.WORK, 0);
	}
	public WORKLOAD(): TerminalNode {
		return this.getToken(SqlParser.WORKLOAD, 0);
	}
	public XML(): TerminalNode {
		return this.getToken(SqlParser.XML, 0);
	}
    ...
    public get ruleIndex(): number {
    	return SqlParser.RULE_simple_id;
	}
	public enterRule(listener: SqlListener): void {
...
export class Comparison_operatorContext extends ParserRuleContext {
	...
	public GREATER(): TerminalNode {
		return this.getToken(SqlParser.GREATER, 0);
	}
	public LESS_EQUAL(): TerminalNode {
		return this.getToken(SqlParser.LESS_EQUAL, 0);
	}
	public GREATER_EQUAL(): TerminalNode {
		return this.getToken(SqlParser.GREATER_EQUAL, 0);
	}
	public NOT_EQUAL(): TerminalNode {
		return this.getToken(SqlParser.NOT_EQUAL, 0);
	}
	public EXCLAMATION(): TerminalNode {
		return this.getToken(SqlParser.EXCLAMATION, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_comparison_operator;
	}
	public enterRule(listener: SqlListener): void {
...
export class Assignment_operatorContext extends ParserRuleContext {
	...
	public PLUS_ASSIGN(): TerminalNode {
		return this.getToken(SqlParser.PLUS_ASSIGN, 0);
	}
	public MINUS_ASSIGN(): TerminalNode {
		return this.getToken(SqlParser.MINUS_ASSIGN, 0);
	}
	public MULT_ASSIGN(): TerminalNode {
		return this.getToken(SqlParser.MULT_ASSIGN, 0);
	}
	public DIV_ASSIGN(): TerminalNode {
		return this.getToken(SqlParser.DIV_ASSIGN, 0);
	}
	public MOD_ASSIGN(): TerminalNode {
		return this.getToken(SqlParser.MOD_ASSIGN, 0);
	}
	public AND_ASSIGN(): TerminalNode {
		return this.getToken(SqlParser.AND_ASSIGN, 0);
	}
	public XOR_ASSIGN(): TerminalNode {
		return this.getToken(SqlParser.XOR_ASSIGN, 0);
	}
	public OR_ASSIGN(): TerminalNode {
		return this.getToken(SqlParser.OR_ASSIGN, 0);
	}
    public get ruleIndex(): number {
    	return SqlParser.RULE_assignment_operator;
	}
	public enterRule(listener: SqlListener): void {
